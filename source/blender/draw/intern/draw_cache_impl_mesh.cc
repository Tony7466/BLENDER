                                           ...
                                           const bool use_hide)
{
  ...
  const bool do_update_sculpt_normals = ob.sculpt && bke::object::pbvh_get_from_eval(ob);
  if (do_update_sculpt_normals) {
    bke::pbvh::update_normals_from_eval(
        ob, *const_cast<blender::bke::pbvh::Tree *>(blender::bke::object::pbvh_get_from_eval(ob)));
  }
