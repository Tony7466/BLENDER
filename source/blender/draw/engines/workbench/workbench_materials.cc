    ...
    switch (node->type) {
      case SH_NODE_TEX_IMAGE: {
        ...
        switch (storage->extension) {
          ...
          default:
            r_sampler->wrapping_x = GPU_SAMPLER_WRAP_EXTEND;
            r_sampler->wrapping_y = GPU_SAMPLER_WRAP_EXTEND;
            break;
          case SHD_IMAGE_EXTENSION_REPEAT:
            r_sampler->wrapping_x = GPU_SAMPLER_WRAP_REPEAT;
            r_sampler->wrapping_y = GPU_SAMPLER_WRAP_REPEAT;
            break;
          case SHD_IMAGE_EXTENSION_MIRROR:
            r_sampler->wrapping_x = GPU_SAMPLER_WRAP_MIRRORED_REPEAT;
            r_sampler->wrapping_y = GPU_SAMPLER_WRAP_MIRRORED_REPEAT;
            break;
          case SHD_IMAGE_EXTENSION_CLIP:
            r_sampler->wrapping_x = GPU_SAMPLER_WRAP_CLIP;
            r_sampler->wrapping_y = GPU_SAMPLER_WRAP_CLIP;
            break;
        }
        break;
      }
