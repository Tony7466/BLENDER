...
void ShadowModule::begin_sync()
{
...

  {
...

    {
      ...
      sub.push_constant("tilemap_projection_ratio", &data_.tilemap_projection_ratio_buf);
      sub.bind_resources(inst_.lights);
...
void ShadowModule::set_view(View &view, GPUTexture *depth_tx)
{
  ...
  data_.tilemap_projection_ratio_buf = tilemap_pixel_radius() / pixel_world_radius_;
