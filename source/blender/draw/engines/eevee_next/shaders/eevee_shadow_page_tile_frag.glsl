...
#  ifdef GPU_METAL
  ...
  shadow_atlas_img.texture->write(u_depth, ushort2(interp_noperspective.out_texel_xy),interp_flat.out_page_z);
#  else
  imageStore(shadow_atlas_img, ivec3(interp_noperspective.out_texel_xy, interp_flat.out_page_z), uvec4(u_depth));
#  endif
}
