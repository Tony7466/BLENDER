...
void main()
{
  ...
  ivec2 texel_fullres = texel * g_buf.raytrace.resolution_scale + g_buf.raytrace.resolution_bias;
  ...
  hit = raytrace_screen(g_buf.raytrace,
                        g_buf.hiz,
                        hiz_tx,
                        rand_trace,
                        roughness,
  ...
  radiance *= 1.0 - max(0.0, luma - g_buf.raytrace.brightness_clamp) / luma;
