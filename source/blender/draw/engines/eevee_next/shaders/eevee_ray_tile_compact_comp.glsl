...
void main()
{
  ...
  for (int x = 0; x < g_buf.raytrace.resolution_scale; x++) {
    for (int y = 0; y < g_buf.raytrace.resolution_scale; y++) {
      ivec2 full_res_tile = tile * g_buf.raytrace.resolution_scale + ivec2(x, y);
