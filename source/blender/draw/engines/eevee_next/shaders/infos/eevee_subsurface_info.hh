...
GPU_SHADER_CREATE_INFO(eevee_subsurface_data)
    .additional_info("eevee_global_data")
    .define("sss_buf", "global_buf.subsurface");

GPU_SHADER_CREATE_INFO(eevee_subsurface_eval)
    .do_static_compilation(true)
    .additional_info("eevee_shared", "eevee_subsurface_data", "eevee_render_pass_out")
