...
void main()
{
  ...
  if (uniform_buf.film.display_only) {
    ...
    if (uniform_buf.film.display_id == -1) {
      ...
      out_color.rgb =
          imageLoadFast(value_accum_img, ivec3(texel_film, uniform_buf.film.display_id)).rrr;
      out_color.a = 1.0;
    }
      ...
      out_color = cryptomatte_false_color(
          imageLoadFast(cryptomatte_img, ivec3(texel_film, uniform_buf.film.display_id)).r);
    }
  }
  else {
