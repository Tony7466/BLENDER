...
float shadow_tile_depth_get(depth2DArray atlas_tx, ShadowTileData tile, vec2 atlas_uv)
{
...
ShadowSample shadow_punctual_sample_get(
    depth2DArray atlas_tx, usampler2D tilemaps_tx, LightData light, vec3 lP, vec3 lNg)
{
...
ShadowSample shadow_directional_sample_get(
    depth2DArray atlas_tx, usampler2D tilemaps_tx, LightData light, vec3 P, vec3 lNg)
{
