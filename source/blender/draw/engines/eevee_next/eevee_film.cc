...
void Film::sync()
{
  ...
  accumulate_ps_.shader_constant_set(SC_display_only_SLOT, &inst_.film.get_data().display_only);
  accumulate_ps_.shader_constant_set(SC_combined_id_SLOT, &inst_.film.get_data().combined_id);
  accumulate_ps_.shader_constant_set(SC_has_data_SLOT, &inst_.film.get_data().has_data);
  accumulate_ps_.shader_constant_set(SC_use_reprojection_SLOT,
                                     &inst_.film.get_data().use_reprojection);
  accumulate_ps_.shader_constant_set(SC_use_history_SLOT, &inst_.film.get_data().use_history);
  accumulate_ps_.shader_constant_set(SC_normal_id_SLOT, &inst_.film.get_data().normal_id);
  accumulate_ps_.shader_constant_set(SC_any_render_pass_1_SLOT,
                                     &inst_.film.get_data().any_render_pass_1);
  accumulate_ps_.shader_constant_set(SC_any_render_pass_2_SLOT,
                                     &inst_.film.get_data().any_render_pass_2);
  accumulate_ps_.shader_constant_set(SC_any_render_pass_3_SLOT,
                                     &inst_.film.get_data().any_render_pass_3);
  accumulate_ps_.shader_constant_set(SC_aov_color_len_SLOT, &inst_.film.get_data().aov_color_len);
  accumulate_ps_.shader_constant_set(SC_cryptomatte_samples_len_SLOT,
