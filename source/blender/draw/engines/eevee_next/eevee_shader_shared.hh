...
#define LOCAL_LIGHT_COMMON \
  ...
  float shadow_projection_shift_x; \
  float shadow_projection_shift_y; \
  float shadow_projection_shift_z;
...
static inline LightSpotData light_local_data_get(LightData light)
{
  ...
  SAFE_ASSIGN_FLOAT(shadow_projection_shift_x, shadow_projection_shift_x)
  SAFE_ASSIGN_FLOAT(shadow_projection_shift_y, shadow_projection_shift_y)
  SAFE_ASSIGN_FLOAT(shadow_projection_shift_z, shadow_projection_shift_z)
...
static inline LightSunData light_sun_data_get(LightData light)
{
  ...
  SAFE_ASSIGN_FLOAT_AS_INT2_COMBINE(
      clipmap_base_offset_neg, shadow_scale, shadow_projection_shift_x)
  SAFE_ASSIGN_FLOAT_AS_INT2_COMBINE(
      clipmap_base_offset_pos, shadow_projection_shift_y, shadow_projection_shift_z)
