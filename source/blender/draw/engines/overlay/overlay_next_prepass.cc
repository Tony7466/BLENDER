...
void Prepass::object_sync(Manager &manager, const ObjectRef &ob_ref, Resources &res)
{
...
void Prepass::draw(Resources &res, Manager &manager, View &view)
{
...
void Prepass::draw_in_front(Resources &res, Manager &manager, View &view)
{
  /* Should be fine to use the line buffer since the prepass only writes to the depth buffer. */
