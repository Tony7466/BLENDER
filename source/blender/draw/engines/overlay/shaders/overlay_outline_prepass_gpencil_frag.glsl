...
void main()
{
  if (gpencil_stroke_round_cap_mask(gp_flat_interp.sspos.xy,
                                    gp_flat_interp.sspos.zw,
                                    gp_flat_interp.aspect,
                                    gp_noperspective_interp.thickness.x,
                                    gp_noperspective_interp.hardness) < 0.001)
  {
    discard;
    return;
  }
