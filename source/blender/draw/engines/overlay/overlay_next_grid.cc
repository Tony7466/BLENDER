...
void Grid::update_ubo(const State &state, const View &view)
{
...
void Grid::begin_sync(Resources &res, const State &state, const View &view)
{
...
void Grid::draw(Resources &res, Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }
