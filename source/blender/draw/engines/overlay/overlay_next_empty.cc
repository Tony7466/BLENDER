...
void Empties::object_sync(const ObjectRef &ob_ref, Resources &res, const State &state)
{
...
void Empties::end_sync(Resources &res, ShapeCache &shapes, const State &state)
{
...
void Empties::draw(Resources &res, Manager &manager, View &view)
{
  GPU_framebuffer_bind(res.overlay_line_fb);
  manager.submit(empty_ps_, view);
}

void Empties::draw_in_front(Resources &res, Manager &manager, View &view)
{
