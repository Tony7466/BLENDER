...
const ImFileType IMB_FILE_TYPES[] = {
    ...
    },
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_png,
        .is_a_from_file = imb_is_a_png_file,
        .load = imb_load_png,
        .load_filepath = NULL,
    ...
    },
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_bmp,
        .is_a_from_file = imb_is_a_bmp_file,
        .load = imb_load_bmp,
        .load_filepath = NULL,
        .load_filepath_thumbnail = NULL,
        .save = imb_save_bmp,
    ...
    },
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_tga,
        .is_a_from_file = imb_is_a_tga_file,
        .load = imb_load_tga,
        .load_filepath = NULL,
        .load_filepath_thumbnail = NULL,
        .save = imb_save_tga,
...
#ifdef WITH_CINEON
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_dpx,
        .is_a_from_file = imb_is_a_dpx_file,
        .load = imb_load_dpx,
        .load_filepath = NULL,
        .load_filepath_thumbnail = NULL,
        .save = imb_save_dpx,
...
#endif
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_tiff,
        .is_a_from_file = imb_is_a_tiff_file,
        .load = imb_load_tiff,
        .load_filepath = NULL,
        .load_filepath_thumbnail = NULL,
        .save = imb_save_tiff,
    ...
    },
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_hdr,
        .is_a_from_file = imb_is_a_hdr_file,
        .load = imb_load_hdr,
        .load_filepath = NULL,
        .load_filepath_thumbnail = NULL,
        .save = imb_save_hdr,
...
#endif
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_dds,
        .is_a_from_file = imb_is_a_dds_file,
        .load = imb_load_dds,
        .load_filepath = NULL,
        .load_filepath_thumbnail = NULL,
        .save = NULL,
    ...
    },
    {
        ...
        .exit = NULL,
        .is_a = imb_is_a_psd,
        .is_a_from_file = imb_is_a_psd_file,
        .load = imb_load_psd,
        .load_filepath = NULL,
        .load_filepath_thumbnail = NULL,
        .save = NULL,
