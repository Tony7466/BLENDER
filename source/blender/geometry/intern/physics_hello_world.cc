...
#include "GEO_physics_hello_world.hh"
...
void jolt_hello_world()
{
  ...
  while (body_interface.IsActive(sphere_id)) {
    ...
    // in order to keep the simulation stable. Do 1 collision step per 1 / 60th of a second (round
    // up).
  ...
  // Remove the sphere from the physics system. Note that the sphere itself keeps all of its state
  // and can be re-added at any time.
