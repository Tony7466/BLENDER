...
typedef enum NodeMathOperation {
  ...
  NODE_MATH_TRUNCATED_MODULO = 17,
  NODE_MATH_FLOORED_MODULO = 18,
  NODE_MATH_ABSOLUTE = 19,
  NODE_MATH_ARCTAN2 = 20,
  NODE_MATH_FLOOR = 21,
  NODE_MATH_CEIL = 22,
  NODE_MATH_FRACTION = 23,
  NODE_MATH_SQRT = 24,
  NODE_MATH_INV_SQRT = 25,
  NODE_MATH_SIGN = 26,
  NODE_MATH_EXPONENT = 27,
  NODE_MATH_RADIANS = 28,
  NODE_MATH_DEGREES = 29,
  NODE_MATH_SINH = 30,
  NODE_MATH_COSH = 31,
  NODE_MATH_TANH = 32,
  NODE_MATH_TRUNC = 33,
  NODE_MATH_SNAP = 34,
  NODE_MATH_WRAP = 35,
  NODE_MATH_COMPARE = 36,
  NODE_MATH_MULTIPLY_ADD = 37,
  NODE_MATH_PINGPONG = 38,
  NODE_MATH_SMOOTH_MIN = 39,
  NODE_MATH_SMOOTH_MAX = 40,
} NodeMathOperation;
