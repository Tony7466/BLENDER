...
typedef enum NodeIntegerMathOperation {
  ...
  NODE_INTEGER_MATH_REMAINDER = 17,
  NODE_INTEGER_MATH_SQUARE = 18,
  NODE_INTEGER_MATH_CUBE = 19,
  NODE_INTEGER_MATH_CLAMP = 20,
  NODE_INTEGER_MATH_CLAMP_RANGE = 21,
  NODE_INTEGER_MATH_DISTANCE = 22,
  NODE_INTEGER_MATH_AND = 23,
  NODE_INTEGER_MATH_OR = 24,
  NODE_INTEGER_MATH_XOR = 25,
  NODE_INTEGER_MATH_NOT = 26,
  NODE_INTEGER_MATH_AND_NOT = 27,
  NODE_INTEGER_MATH_LEFT_SHIFT = 28,
  NODE_INTEGER_MATH_RIGHT_SHIFT = 29,
} NodeIntegerMathOperation;
