...
typedef enum NodeMatrixMathOperation {
  ...
  NODE_MATRIX_MATH_ADD = 1,
  NODE_MATRIX_MATH_SUBTRACT = 2,
  NODE_MATRIX_MATH_SCALE = 3,
  NODE_MATRIX_MATH_INVERT = 4,
  NODE_MATRIX_MATH_TRANSPOSE = 5,
  NODE_MATRIX_MATH_NORMALIZE = 6,
  NODE_MATRIX_MATH_DETERMINANT = 7,
  NODE_MATRIX_MATH_ADJOINT = 8,
