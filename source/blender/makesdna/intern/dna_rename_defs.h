...
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, x1, left)
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, x2, right)
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, y1, up)
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, y2, down)
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, fac_x1, fac_left)
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, fac_x2, fac_right)
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, fac_y1, fac_up)
DNA_STRUCT_RENAME_MEMBER(NodeTwoXYs, fac_y2, fac_down)
