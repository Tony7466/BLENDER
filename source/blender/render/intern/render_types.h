 ...
 * output composite node. In that case, the output will be written from the File Output nodes,
 * since the render pipeline will early fail if neither a File Output nor a Composite node exist in
 * the scene. */
