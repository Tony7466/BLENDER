                                     ...
                                     const int view_id)
{
  ...
  IMB_colormanagement_assign_float_colorspace(ibuf, imf->linear_colorspace_settings.name);
  IMB_colormanagement_assign_byte_colorspace(ibuf, imf->linear_colorspace_settings.name);
