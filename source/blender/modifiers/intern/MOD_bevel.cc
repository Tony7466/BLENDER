...
static void profile_panel_draw(uiLayout *layout, PointerRNA *ptr)
{
...

  {
    ...
    uiItemR(row, ptr, "profile_type", UI_ITEM_R_EXPAND, nullptr, ICON_NONE);
  }
...
static void panel_draw(const bContext *C, Panel *panel)
{
  ...
  if (uiLayout *panel_layout = uiLayoutPanel(C, layout, "Profile", ptr, "open_profile_panel")) {
    profile_panel_draw(panel_layout, ptr);
  }
  if (uiLayout *panel_layout = uiLayoutPanel(C, layout, "Geometry", ptr, "open_geometry_panel")) {
    geometry_panel_draw(panel_layout, ptr);
  }
  if (uiLayout *panel_layout = uiLayoutPanel(C, layout, "Shading", ptr, "open_shading_panel")) {
