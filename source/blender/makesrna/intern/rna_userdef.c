...
#  endif
  ...
  RNA_def_property_enum_sdna(prop, NULL, "system_cursor");
  ...
  RNA_def_property_enum_sdna(prop, NULL, "paint_cursor");
  ...
  RNA_def_property_enum_sdna(prop, NULL, "dot_cursor");
  ...
  RNA_def_property_enum_sdna(prop, NULL, "knife_cursor");
  ...
  RNA_def_property_enum_sdna(prop, NULL, "eyedropper_cursor");
  ...
  RNA_def_property_enum_sdna(prop, NULL, "eraser_cursor");
  ...
  RNA_def_property_enum_sdna(prop, NULL, "pencil_cursor");
