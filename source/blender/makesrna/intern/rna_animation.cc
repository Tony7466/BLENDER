...
static void rna_AnimData_action_slot_set(PointerRNA *ptr, PointerRNA value, ReportList *reports)
{
  ...
  if (!dna_slot) {
    blender::animrig::unassign_slot(*animated_id);
    return;
  }
                                                     ...
                                                     PointerRNA *ptr)
{
  ...
  Action &action = adt.action->wrap();
  blender::Span<Slot *> slots = action.slots();
...
static int rna_AnimData_action_slot_enum_get(PointerRNA *ptr)
{
  AnimData &adt = rna_animdata(ptr);
  return adt.slot_handle;
}

static void rna_AnimData_action_slot_enum_set(PointerRNA *ptr, int value)
{
  using blender::animrig::Action;
  using blender::animrig::Slot;
...
static const EnumPropertyItem *rna_AnimData_action_slot_enum_itemf(bContext * /*C*/,
                                                                   PointerRNA *ptr,
                                                                   PropertyRNA * /*prop*/,
                                                                   bool *r_free)
{
...
#  ifdef WITH_ANIM_BAKLAVA
  ...
  prop = RNA_def_property(srna, "action_slot_enum", PROP_ENUM, PROP_NONE);
  RNA_def_property_enum_funcs(prop,
                              "rna_AnimData_action_slot_enum_get",
                              "rna_AnimData_action_slot_enum_set",
                              "rna_AnimData_action_slot_enum_itemf");
