...
const EnumPropertyItem rna_enum_node_matrix_math_items[] = {
    ...
    {NODE_MATRIX_MATH_SCALE, "SCALE", 0, "Scale", "A * B"},
    RNA_ENUM_ITEM_SEPR,
    {NODE_MATRIX_MATH_INVERT,
     "INVERT",
     0,
     "Invert",
     "Inverts the matrix, or returns the identity matrix when non-invertable"},
    ...
    {NODE_MATRIX_MATH_NORMALIZE,
     ...
     0,
     "Normalize",
     "Normalizes each column of the matrix individually"},
    RNA_ENUM_ITEM_SEPR,
