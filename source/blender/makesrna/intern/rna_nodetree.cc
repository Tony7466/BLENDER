...
// static void rna_NodeTree_inputs_move(bNodeTree *ntree, Main *bmain, int from_index, int
// to_index)
//{
...
// static void rna_NodeTree_outputs_move(bNodeTree *ntree, Main *bmain, int from_index, int
// to_index)
//{
//  if (from_index == to_index) {
//    return;
...
// static void rna_NodeTree_panels_move(bNodeTree *ntree, Main *bmain, int from_index, int
// to_index)
//{
...
static void rna_def_nodetree(BlenderRNA *brna)
{
  ...
  //  RNA_def_property_struct_type(prop, "NodePanel");
  //  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
  //  RNA_def_property_ui_text(prop, "Panels", "UI panels for structuring the node tree
  //  interface"); rna_def_node_tree_socket_panels_api(brna, prop);
