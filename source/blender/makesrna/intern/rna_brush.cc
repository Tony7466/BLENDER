...
const EnumPropertyItem rna_enum_brush_sculpt_tool_items[] = {
    ...
    {SCULPT_TOOL_DRAW_SHARP, "DRAW_SHARP", ICON_BRUSH_SCULPT_DRAW_SHARP, "Draw Sharp", ""},
    {SCULPT_TOOL_CLAY, "CLAY", ICON_BRUSH_CLAY, "Clay", ""},
    {SCULPT_TOOL_CLAY_STRIPS, "CLAY_STRIPS", ICON_BRUSH_CLAY_STRIPS, "Clay Strips", ""},
    {SCULPT_TOOL_CLAY_THUMB, "CLAY_THUMB", ICON_BRUSH_CLAY_THUMB, "Clay Thumb", ""},
    ...
    {SCULPT_TOOL_MULTIPLANE_SCRAPE,
     "MULTIPLANE_SCRAPE",
     ICON_BRUSH_MULTIPLANE_SCRAPE,
     "Multi-plane Scrape",
     ""},
    {SCULPT_TOOL_PINCH, "PINCH", ICON_BRUSH_PINCH, "Pinch", ""},
    RNA_ENUM_ITEM_SEPR,
    {SCULPT_TOOL_GRAB, "GRAB", ICON_BRUSH_GRAB, "Grab", ""},
    {SCULPT_TOOL_ELASTIC_DEFORM, "ELASTIC_DEFORM", ICON_BRUSH_ELASTIC_GRAB, "Elastic Deform", ""},
    {SCULPT_TOOL_SNAKE_HOOK, "SNAKE_HOOK", ICON_BRUSH_SNAKE_HOOK, "Snake Hook", ""},
    {SCULPT_TOOL_THUMB, "THUMB", ICON_BRUSH_THUMB, "Thumb", ""},
    {SCULPT_TOOL_POSE, "POSE", ICON_BRUSH_POSE, "Pose", ""},
    {SCULPT_TOOL_NUDGE, "NUDGE", ICON_BRUSH_NUDGE, "Nudge", ""},
    {SCULPT_TOOL_ROTATE, "ROTATE", ICON_BRUSH_ROTATE, "Rotate", ""},
    {SCULPT_TOOL_SLIDE_RELAX, "TOPOLOGY", ICON_BRUSH_SLIDE_RELAX, "Slide Relax", ""},
    {SCULPT_TOOL_BOUNDARY, "BOUNDARY", ICON_BRUSH_BOUNDARY, "Boundary", ""},
    RNA_ENUM_ITEM_SEPR,
    {SCULPT_TOOL_CLOTH, "CLOTH", ICON_BRUSH_CLOTH, "Cloth", ""},
    {SCULPT_TOOL_SIMPLIFY, "SIMPLIFY", ICON_BRUSH_SIMPLIFY, "Simplify", ""},
    {SCULPT_TOOL_MASK, "MASK", ICON_BRUSH_MASK, "Mask", ""},
    {SCULPT_TOOL_DRAW_FACE_SETS, "DRAW_FACE_SETS", ICON_BRUSH_DRAW_FACE_SETS, "Draw Face Sets", ""},
    {SCULPT_TOOL_DISPLACEMENT_ERASER,
     "DISPLACEMENT_ERASER",
     ICON_BRUSH_DISPLACEMENT_ERASER,
     "Multires Displacement Eraser",
     ""},
    {SCULPT_TOOL_DISPLACEMENT_SMEAR,
     "DISPLACEMENT_SMEAR",
     ICON_BRUSH_DISPLACEMENT_SMEAR,
     "Multires Displacement Smear",
     ""},
    {SCULPT_TOOL_PAINT, "PAINT", ICON_BRUSH_TEXDRAW, "Paint", ""},
    {SCULPT_TOOL_SMEAR, "SMEAR", ICON_BRUSH_SMEAR, "Smear", ""},
    {0, nullptr, 0, nullptr, nullptr},
};
...
const EnumPropertyItem rna_enum_brush_vertex_tool_items[] = {
    {VPAINT_TOOL_DRAW, "DRAW", ICON_BRUSH_TEXDRAW, "Draw", ""},
    {VPAINT_TOOL_BLUR, "BLUR", ICON_BRUSH_SOFTEN, "Blur", ""},
    {VPAINT_TOOL_AVERAGE, "AVERAGE", ICON_BRUSH_AVERAGE, "Average", ""},
    {VPAINT_TOOL_SMEAR, "SMEAR", ICON_BRUSH_SMEAR, "Smear", ""},
    {0, nullptr, 0, nullptr, nullptr},
};
...
const EnumPropertyItem rna_enum_brush_image_tool_items[] = {
    ...
    {PAINT_TOOL_MASK, "MASK", ICON_BRUSH_MASK, "Mask", ""},
    {0, nullptr, 0, nullptr, nullptr},
};
