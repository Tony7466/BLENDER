...
static const EnumPropertyItem event_ndof_type_items[] = {
    ...
    {NDOF_BUTTON_KBP_F1, "NDOF_BUTTON_KBP_F1", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F1"), ""},
    {NDOF_BUTTON_KBP_F2, "NDOF_BUTTON_KBP_F2", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F2"), ""},
    {NDOF_BUTTON_KBP_F3, "NDOF_BUTTON_KBP_F3", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F3"), ""},
    {NDOF_BUTTON_KBP_F4, "NDOF_BUTTON_KBP_F4", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F4"), ""},
    {NDOF_BUTTON_KBP_F5, "NDOF_BUTTON_KBP_F5", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F5"), ""},
    {NDOF_BUTTON_KBP_F6, "NDOF_BUTTON_KBP_F6", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F6"), ""},
    {NDOF_BUTTON_KBP_F7, "NDOF_BUTTON_KBP_F7", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F7"), ""},
    {NDOF_BUTTON_KBP_F8, "NDOF_BUTTON_KBP_F8", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F8"), ""},
    {NDOF_BUTTON_KBP_F9, "NDOF_BUTTON_KBP_F9", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F9"), ""},
    {NDOF_BUTTON_KBP_F10, "NDOF_BUTTON_KBP_F10", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F10"), ""},
    {NDOF_BUTTON_KBP_F11, "NDOF_BUTTON_KBP_F11", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F11"), ""},
    {NDOF_BUTTON_KBP_F12, "NDOF_BUTTON_KBP_F12", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F12"), ""},
    {NDOF_BUTTON_NP_F1, "NDOF_BUTTON_NP_F1", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F1"), ""},
    {NDOF_BUTTON_NP_F2, "NDOF_BUTTON_NP_F2", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F2"), ""},
    {NDOF_BUTTON_NP_F3, "NDOF_BUTTON_NP_F3", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F3"), ""},
    {NDOF_BUTTON_NP_F4, "NDOF_BUTTON_NP_F4", 0,  CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F4"), ""},
...
const EnumPropertyItem rna_enum_event_type_items[] = {
    ...
    {NDOF_BUTTON_KBP_F1, "NDOF_BUTTON_KBP_F1", 0, "NDOF F1", "NdofF1"},
    {NDOF_BUTTON_KBP_F2, "NDOF_BUTTON_KBP_F2", 0, "NDOF F2", "NdofF2"},
    {NDOF_BUTTON_KBP_F3, "NDOF_BUTTON_KBP_F3", 0, "NDOF F3", "NdofF3"},
    {NDOF_BUTTON_KBP_F4, "NDOF_BUTTON_KBP_F4", 0, "NDOF F4", "NdofF4"},
    {NDOF_BUTTON_KBP_F5, "NDOF_BUTTON_KBP_F5", 0, "NDOF F5", "NdofF5"},
    {NDOF_BUTTON_KBP_F6, "NDOF_BUTTON_KBP_F6", 0, "NDOF F6", "NdofF6"},
    {NDOF_BUTTON_KBP_F7, "NDOF_BUTTON_KBP_F7", 0, "NDOF F7", "NdofF7"},
    {NDOF_BUTTON_KBP_F8, "NDOF_BUTTON_KBP_F8", 0, "NDOF F8", "NdofF8"},
    {NDOF_BUTTON_KBP_F9, "NDOF_BUTTON_KBP_F9", 0, "NDOF F9", "NdofF9"},
    {NDOF_BUTTON_KBP_F10, "NDOF_BUTTON_KBP_F10", 0, "NDOF F10", "NdofF10"},
    {NDOF_BUTTON_KBP_F11, "NDOF_BUTTON_KBP_F11", 0, "NDOF F11", "NdofF11"},
    {NDOF_BUTTON_KBP_F12, "NDOF_BUTTON_KBP_F12", 0, "NDOF F12", "NdofF12"},
    {NDOF_BUTTON_NP_F1, "NDOF_BUTTON_NP_F1", 0, "NDOF NP F1", "NdofNPF1"},
    {NDOF_BUTTON_NP_F2, "NDOF_BUTTON_NP_F2", 0, "NDOF NP F2", "NdofNPF2"},
    {NDOF_BUTTON_NP_F3, "NDOF_BUTTON_NP_F3", 0, "NDOF NP F3", "NdofNPF3"},
    {NDOF_BUTTON_NP_F4, "NDOF_BUTTON_NP_F4", 0, "NDOF NP F4", "NdofNPF4"},
