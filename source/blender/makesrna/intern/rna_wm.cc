...
static const EnumPropertyItem event_ndof_type_items[] = {
    ...
    {NDOF_BUTTON_KBP_F1,
     "NDOF_BUTTON_KBP_F1",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F1"),
     ""},
    {NDOF_BUTTON_KBP_F2,
     "NDOF_BUTTON_KBP_F2",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F2"),
     ""},
    {NDOF_BUTTON_KBP_F3,
     "NDOF_BUTTON_KBP_F3",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F3"),
     ""},
    {NDOF_BUTTON_KBP_F4,
     "NDOF_BUTTON_KBP_F4",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F4"),
     ""},
    {NDOF_BUTTON_KBP_F5,
     "NDOF_BUTTON_KBP_F5",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F5"),
     ""},
    {NDOF_BUTTON_KBP_F6,
     "NDOF_BUTTON_KBP_F6",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F6"),
     ""},
    {NDOF_BUTTON_KBP_F7,
     "NDOF_BUTTON_KBP_F7",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F7"),
     ""},
    {NDOF_BUTTON_KBP_F8,
     "NDOF_BUTTON_KBP_F8",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F8"),
     ""},
    {NDOF_BUTTON_KBP_F9,
     "NDOF_BUTTON_KBP_F9",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F9"),
     ""},
    {NDOF_BUTTON_KBP_F10,
     "NDOF_BUTTON_KBP_F10",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F10"),
     ""},
    {NDOF_BUTTON_KBP_F11,
     "NDOF_BUTTON_KBP_F11",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F11"),
     ""},
    {NDOF_BUTTON_KBP_F12,
     "NDOF_BUTTON_KBP_F12",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "Button F12"),
     ""},
    {NDOF_BUTTON_NP_F1,
     "NDOF_BUTTON_NP_F1",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F1"),
     ""},
    {NDOF_BUTTON_NP_F2,
     "NDOF_BUTTON_NP_F2",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F2"),
     ""},
    {NDOF_BUTTON_NP_F3,
     "NDOF_BUTTON_NP_F3",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F3"),
     ""},
    {NDOF_BUTTON_NP_F4,
     "NDOF_BUTTON_NP_F4",
     0,
     CTX_N_(BLT_I18NCONTEXT_UI_EVENTS, "NP Button F4"),
     ""},
