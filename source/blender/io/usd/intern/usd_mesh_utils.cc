 ...
 */
template pxr::VtArray<pxr::GfVec2f> get_prim_attribute_array<pxr::GfVec2f>(const pxr::UsdGeomPrimvar &primvar,
                                                                           const double motionSampleTime,
                                                                           ReportList *reports);
template pxr::VtArray<pxr::GfVec3f> get_prim_attribute_array<pxr::GfVec3f>(const pxr::UsdGeomPrimvar &primvar,
                                                                           const double motionSampleTime,
                                                                           ReportList *reports);
                             ...
                             bool is_left_handed)
{
  ...
  pxr::VtArray<pxr::GfVec3f> usd_colors = get_prim_attribute_array<pxr::GfVec3f>(primvar, motion_sample_time, reports);
