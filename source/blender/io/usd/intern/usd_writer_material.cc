    ...
    if (input_link) {
      ...
      if (scale_link) {
        ...
        if (vector_math_node->custom1 == NODE_VECTOR_MATH_MULTIPLY_ADD) {
          ...
          bNodeSocket *sock_current = blender::bke::nodeFindSocket(vector_math_node, SOCK_IN, "Vector");
          ...
          bNodeSocket *sock_scale = blender::bke::nodeFindSocket(vector_math_node, SOCK_IN, "Vector_001");
          bNodeSocket *sock_bias = blender::bke::nodeFindSocket(vector_math_node, SOCK_IN, "Vector_002");
