...
TEST_F(OBJImportTest, import_all_objects)
{
  Expectation expect[] = {
      ...
      {"OBSurfTorus.001",
       ...
       1024,
       4096,
       float3(5.3446698188781738, -2.6553299427032471, -0.17677700519561768),
       float3(5.2327919006347656, -2.411794900894165, -0.22083500027656555),
       float3(-0.50418281555175781, -0.50418299436569214, -0.701141357421875),
       float2(0, 1)},
      {"OBSurfTorus.002",
       OB_MESH,
       1024,
