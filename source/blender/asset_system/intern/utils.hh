 ...
 *
 * If \a max_len is not #StringRef::not_found, only the first part of the given string up to the
 * given length is processed, the rest remains unchanged. Needed to avoid modifying ID name part of
