...
static const PyC_StringEnumItems pygpu_imagetype_items[] = {
    ...
    {int(ImageType::INT_ATOMIC_2D), "INT_ATOMIC_2D"},
    {int(ImageType::INT_ATOMIC_2D_ARRAY), "INT_ATOMIC_2D_ARRAY"},
    {int(ImageType::INT_ATOMIC_3D), "INT_ATOMIC_3D"},
    ...
    {int(ImageType::UINT_ATOMIC_2D), "UINT_ATOMIC_2D"},
    {int(ImageType::UINT_ATOMIC_2D_ARRAY), "UINT_ATOMIC_2D_ARRAY"},
    {int(ImageType::UINT_ATOMIC_3D), "UINT_ATOMIC_3D"},
