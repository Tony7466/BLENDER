...
static void customdata_version_242(Mesh *me)
{
  ...
  if (!me->vdata.totlayer) {
    CustomData_add_layer_with_existing_data(&me->vdata, CD_MVERT, me->mvert, me->totvert);

    if (me->dvert) {
      CustomData_add_layer_with_existing_data(&me->vdata, CD_MDEFORMVERT, me->dvert, me->totvert);
    }
  }

  if (!me->edata.totlayer) {
    CustomData_add_layer_with_existing_data(&me->edata, CD_MEDGE, me->medge, me->totedge);
  }

  if (!me->fdata.totlayer) {
    CustomData_add_layer_with_existing_data(&me->fdata, CD_MFACE, me->mface, me->totface);
    ...
    if (me->tface) {
      ...
      CustomData_add_layer_with_existing_data(&me->fdata, CD_MCOL, me->mcol, me->totface);
    }
  }
