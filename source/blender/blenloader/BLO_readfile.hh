...
/**
 * Ensure that the storage data required to keep allocation information generated by readfile code
 * is initialized.
 *
 * NOTE: This function should be called very early, before #MEM_init_memleak_detection.
 */
