                                                       ...
                                                       std::stringstream &ss)
{
  ...
  else if (socket_type.is<blender::math::Quaternion>()) {
    const blender::math::Quaternion &rotation = *static_cast<blender::math::Quaternion *>(
        socket_value);
    const blender::math::EulerXYZ euler = blender::math::to_euler(rotation);
