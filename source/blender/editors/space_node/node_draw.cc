...
static void create_inspection_string_for_geometry_info(const geo_log::GeometryInfoLog &value_log,
                                                       std::stringstream &ss)
{
  Span<bke::GeometryComponentType> component_types = value_log.component_types;
  ...
  ss << TIP_("Geometry:") << "\n";
  for (bke::GeometryComponentType type : component_types) {
    switch (type) {
                                                         ...
                                                         const bool after_log)
{
  ...
  Span<bke::GeometryComponentType> supported_types = socket_decl->supported_types();
  ...
  ss << TIP_("Supported: ");
  for (bke::GeometryComponentType type : supported_types) {
    switch (type) {
      case bke::GEO_COMPONENT_TYPE_MESH: {
        ss << TIP_("Mesh");
        break;
