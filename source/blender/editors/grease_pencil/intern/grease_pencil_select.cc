...
static int select_all_exec(bContext *C, wmOperator *op)
{
  ...
  bool segment_mode;
  eAttrDomain selection_domain = ED_grease_pencil_selection_domain_get(C, &segment_mode);
...
eAttrDomain ED_grease_pencil_selection_domain_get(bContext *C, bool *segment_mode)
{
