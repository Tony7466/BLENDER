...
void create_blank(Main &bmain, Object &object, const int frame_number)
{
  ...
  grease_pencil.insert_frame(new_layer, frame_number, 0, BEZT_KEYTYPE_KEYFRAME);
}
...
void create_stroke(Main &bmain, Object &object, const float4x4 &matrix, const int frame_number)
{
  ...
  Drawing &drawing_lines = *grease_pencil.insert_frame(
      layer_lines, frame_number, 0, BEZT_KEYTYPE_KEYFRAME);
  grease_pencil.insert_frame(layer_color, frame_number, 0, BEZT_KEYTYPE_KEYFRAME);
...
void create_suzanne(Main &bmain, Object &object, const float4x4 &matrix, const int frame_number)
{
  ...
  Drawing &drawing_lines = *grease_pencil.insert_frame(
      layer_lines, frame_number, 0, BEZT_KEYTYPE_KEYFRAME);
  Drawing &drawing_fills = *grease_pencil.insert_frame(
      layer_fills, frame_number, 0, BEZT_KEYTYPE_KEYFRAME);
