...
extern std::array<float3, 700> monkey_fill_pos;
extern std::array<float, 700> monkey_fill_rad;
extern std::array<float, 700> monkey_fill_opa;
extern std::array<int, 14> monkey_fill_offsets;
extern std::array<float3, 516> monkey_line_pos;
extern std::array<float, 516> monkey_line_rad;
extern std::array<float, 516> monkey_line_opa;
extern std::array<int, 16> monkey_line_offsets;
...
void create_suzanne(Main &bmain, Object &object, float4x4 matrix, const int frame_numer)
{
  ...
  drawing->geometry.wrap() = create_drawing_data(monkey_fill_pos,
                                                monkey_fill_rad,
                                                monkey_fill_opa,
                                                monkey_fill_offsets,
  ...
  drawing = reinterpret_cast<GreasePencilDrawing *>(
      grease_pencil.drawings_for_write()[1]);
  drawing->geometry.wrap() = create_drawing_data(monkey_line_pos,
                                                monkey_line_rad,
                                                monkey_line_opa,
                                                monkey_line_offsets,
  ...
  GreasePencilFrame frame_color{1, 0, BEZT_KEYTYPE_KEYFRAME};
  layer_lines.insert_frame(frame_numer, frame_lines);
  layer_fills.insert_frame(frame_numer, frame_color);
}
