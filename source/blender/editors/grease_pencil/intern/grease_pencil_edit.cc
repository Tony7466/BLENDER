                                                   ...
                                                   const IndexMask &mask)
{
  ...
  gather_attributes(
      src_attributes, bke::AttrDomain::Curve, bke::AttrDomain::Curve, {}, {"cyclic"}, dst_to_src_curve, dst_attributes);
  array_utils::copy(dst_cyclic.as_span(), dst_curves.cyclic_for_write());

  /* Transfer point attributes. */
  gather_attributes(
      src_attributes, bke::AttrDomain::Point, bke::AttrDomain::Point, {}, {}, dst_to_src_point, dst_attributes);
                                                        ...
                                                        const IndexMask &points_to_extrude)
{
  ...
  bke::gather_attributes(
      src_attributes, bke::AttrDomain::Curve, bke::AttrDomain::Curve, {}, {}, dst_to_src_curves, dst_attributes);

  bke::gather_attributes(
      src_attributes, bke::AttrDomain::Point, bke::AttrDomain::Point, {}, {}, dst_to_src_points, dst_attributes);
