      ...
      for (const int x : IndexRange(key.grid_size)) {
        ...
        switch (brush.smear_deform_type) {
          case BRUSH_SMEAR_DEFORM_DRAG:
            current_disp = cache.location_symmetry - cache.last_location_symmetry;
            break;
          case BRUSH_SMEAR_DEFORM_PINCH:
            current_disp = cache.location_symmetry - positions[node_vert_index];
            break;
          case BRUSH_SMEAR_DEFORM_EXPAND:
            current_disp = positions[node_vert_index] - cache.location_symmetry;
            break;
        }
