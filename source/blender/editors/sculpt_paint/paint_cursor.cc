...
static void paint_cursor_sculpt_session_update_and_init(PaintCursorContext *pcontext)
{
  ...
  /* We ensure that the PBVH is generated before we call SCULPT_cursor_geometry_info_update because
   * the PBVH is needed for us to do a raycast to find the active vertex. */
