                                         ...
                                         const size_t end)
{
  ...
  struct ColorItem {
    ...
    int spacetype = SPACE_TYPE_ANY;
      ...
      {"blender.collection_color_01", btheme->collection_color[0].color},
      {"blender.collection_color_02", btheme->collection_color[1].color},
      {"blender.collection_color_03", btheme->collection_color[2].color},
      {"blender.collection_color_04", btheme->collection_color[3].color},
      {"blender.collection_color_05", btheme->collection_color[4].color},
      {"blender.collection_color_06", btheme->collection_color[5].color},
      {"blender.collection_color_07", btheme->collection_color[6].color},
      {"blender.collection_color_08", btheme->collection_color[7].color},
