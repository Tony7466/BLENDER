...
\
  ...
  INIT_BRUSH_ICON(ICON_BRUSH_CLAY_THUMB, clay-thumb);
  ...
  INIT_BRUSH_ICON(ICON_BRUSH_SCULPT_DRAW_SHARP, draw-sharp);
  INIT_BRUSH_ICON(ICON_BRUSH_FILL, fill);
  INIT_BRUSH_ICON(ICON_BRUSH_FLATTEN, flatten);
  INIT_BRUSH_ICON(ICON_BRUSH_GRAB, grab);
  INIT_BRUSH_ICON(ICON_BRUSH_ELASTIC_GRAB, elastic_grab);
  INIT_BRUSH_ICON(ICON_BRUSH_POSE, pose-rotate);
  INIT_BRUSH_ICON(ICON_BRUSH_SLIDE_RELAX, slide-relax);
  INIT_BRUSH_ICON(ICON_BRUSH_BOUNDARY, boundary_bend);
  INIT_BRUSH_ICON(ICON_BRUSH_INFLATE, inflate);
  INIT_BRUSH_ICON(ICON_BRUSH_LAYER, layer);
  INIT_BRUSH_ICON(ICON_BRUSH_MASK, mask);
  INIT_BRUSH_ICON(ICON_BRUSH_DRAW_FACE_SETS, draw-face-sets);
  INIT_BRUSH_ICON(ICON_BRUSH_SIMPLIFY, simplify);
  ...
  INIT_BRUSH_ICON(ICON_BRUSH_MULTIPLANE_SCRAPE, multiplane_scrape);
  ...
  INIT_BRUSH_ICON(ICON_BRUSH_AVERAGE, average);
  INIT_BRUSH_ICON(ICON_BRUSH_TEXDRAW, texdraw);
  INIT_BRUSH_ICON(ICON_BRUSH_TEXFILL, texfill);
  INIT_BRUSH_ICON(ICON_BRUSH_TEXMASK, texmask);
  INIT_BRUSH_ICON(ICON_BRUSH_THUMB, thumb);
  INIT_BRUSH_ICON(ICON_BRUSH_ROTATE, twist);
  INIT_BRUSH_ICON(ICON_BRUSH_CLOTH, cloth_drag);
  INIT_BRUSH_ICON(ICON_BRUSH_DISPLACEMENT_ERASER, multires-eraser);
  INIT_BRUSH_ICON(ICON_BRUSH_DISPLACEMENT_SMEAR, multires-smear);
