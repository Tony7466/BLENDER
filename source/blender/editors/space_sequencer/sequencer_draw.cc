...
static void draw_handle_transform_text(
    const Scene *scene, View2D *v2d, Sequence *seq, const short handle_side, bool y_threshold)
{
                            ...
                            bool y_threshold)
{
  ...
  draw_handle_transform_text(scene, v2d, seq, handle_side, y_threshold);
}
