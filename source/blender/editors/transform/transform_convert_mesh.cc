...
static TransCustomDataMesh *mesh_customdata_ensure(TransDataContainer *tc)
{
  ...
  if (tc->custom.type.data == nullptr) {
    ...
    tcmd->partial_update_state_prev.for_corner_tris = PARTIAL_NONE;
...
static void mesh_partial_types_calc(TransInfo *t, PartialTypeState *r_partial_state)
{
  ...
  enum ePartialType partial_for_corner_tris = PARTIAL_NONE;
  ...
  switch (t->mode) {
    case TFM_TRANSLATION: {
      partial_for_corner_tris = PARTIAL_TYPE_GROUP;
    ...
    default: {
      partial_for_corner_tris = PARTIAL_TYPE_ALL;
      partial_for_normals = PARTIAL_TYPE_ALL;
      break;
    }
  }
  ...
  if (transform_snap_project_individual_is_active(t)) {
    if (partial_for_corner_tris == PARTIAL_TYPE_GROUP) {
      partial_for_corner_tris = PARTIAL_TYPE_ALL;
    }
  ...
  r_partial_state->for_corner_tris = partial_for_corner_tris;
                                ...
                                const PartialTypeState *partial_state)
{
  ...
  if ((partial_for_corner_tris == PARTIAL_TYPE_ALL) && (partial_for_normals == PARTIAL_TYPE_ALL) &&
      (em->bm->totvert == em->bm->totvertsel))
  {
    ...
    if (partial_for_corner_tris != PARTIAL_NONE) {
      BMPartialUpdate *bmpinfo = mesh_partial_ensure(t, tc, partial_for_corner_tris);
    ...
    if (partial_for_normals != PARTIAL_NONE) {
      ...
      const bool face_normals = !((partial_for_corner_tris == PARTIAL_TYPE_ALL) ||
                                  ((partial_for_corner_tris == PARTIAL_TYPE_GROUP) &&
                                   (partial_for_normals == PARTIAL_TYPE_GROUP)));
