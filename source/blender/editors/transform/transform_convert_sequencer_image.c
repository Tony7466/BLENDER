...
static void createTransSeqRetimingData(bContext *UNUSED(C), TransInfo *t)
{
...
static void special_aftertrans_update__sequencer_retiming(bContext *UNUSED(C), TransInfo *t)
{
