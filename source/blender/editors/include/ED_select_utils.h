 ...
 */
std::string ED_select_pick_get_name(struct wmOperatorType *ot, PointerRNA *ptr);
std::string ED_select_circle_get_name(struct wmOperatorType *ot, PointerRNA *ptr);
