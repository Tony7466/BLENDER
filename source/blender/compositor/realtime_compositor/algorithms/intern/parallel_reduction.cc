...
{
  GPUShader *shader = context.get_shader("compositor_sum_red", DataPrecision::Full);
  GPU_shader_bind(shader);

  float *reduced_value = parallel_reduction_dispatch(
      context, texture, shader, Texture::gpu_format(DataType::Float, DataPrecision::Full));
...
{
  GPUShader *shader = context.get_shader("compositor_sum_green", DataPrecision::Full);
  GPU_shader_bind(shader);
...
{
  GPUShader *shader = context.get_shader("compositor_sum_blue", DataPrecision::Full);
  GPU_shader_bind(shader);
...
{
  GPUShader *shader = context.get_shader("compositor_sum_luminance", DataPrecision::Full);
  GPU_shader_bind(shader);
...
{
  GPUShader *shader = context.get_shader("compositor_sum_log_luminance", DataPrecision::Full);
  GPU_shader_bind(shader);
...
{
  GPUShader *shader = context.get_shader("compositor_sum_color", DataPrecision::Full);
  GPU_shader_bind(shader);

  float *reduced_value = parallel_reduction_dispatch(
      context, texture, shader, Texture::gpu_format(DataType::Color, DataPrecision::Full));
...
{
  GPUShader *shader = context.get_shader("compositor_maximum_luminance", DataPrecision::Full);
  GPU_shader_bind(shader);
...
{
  GPUShader *shader = context.get_shader("compositor_maximum_float", DataPrecision::Full);
  GPU_shader_bind(shader);
...
float maximum_float_in_range(Context &context,
                             ...
                             float upper_bound)
{
  GPUShader *shader = context.get_shader("compositor_maximum_float_in_range", DataPrecision::Full);
  GPU_shader_bind(shader);
...
{
  GPUShader *shader = context.get_shader("compositor_minimum_luminance", DataPrecision::Full);
  GPU_shader_bind(shader);
...
{
  GPUShader *shader = context.get_shader("compositor_minimum_float", DataPrecision::Full);
  GPU_shader_bind(shader);
...
float minimum_float_in_range(Context &context,
                             ...
                             float upper_bound)
{
  GPUShader *shader = context.get_shader("compositor_minimum_float_in_range", DataPrecision::Full);
  GPU_shader_bind(shader);
