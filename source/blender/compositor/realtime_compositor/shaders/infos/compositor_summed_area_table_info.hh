...
GPU_SHADER_CREATE_INFO(compositor_summed_area_table_compute_incomplete_prologues)
    .local_group_size(16, 16)
    .sampler(0, ImageType::FLOAT_2D, "input_tx")
    .image(0, GPU_RGBA16F, Qualifier::WRITE, ImageType::FLOAT_2D, "incomplete_x_prologues_img")
    .image(1, GPU_RGBA16F, Qualifier::WRITE, ImageType::FLOAT_2D, "incomplete_y_prologues_img")
...
GPU_SHADER_CREATE_INFO(compositor_summed_area_table_compute_complete_x_prologues)
    ...
    .image(0, GPU_RGBA16F, Qualifier::WRITE, ImageType::FLOAT_2D, "complete_x_prologues_img")
    .image(1, GPU_RGBA16F, Qualifier::WRITE, ImageType::FLOAT_2D, "complete_x_prologues_sum_img")
...
GPU_SHADER_CREATE_INFO(compositor_summed_area_table_compute_complete_y_prologues)
    ...
    .image(0, GPU_RGBA16F, Qualifier::WRITE, ImageType::FLOAT_2D, "complete_y_prologues_img")
    .compute_source("compositor_summed_area_table_compute_complete_y_prologues.glsl")
    .do_static_compilation(true);

GPU_SHADER_CREATE_INFO(compositor_summed_area_table_compute_complete_blocks)
    .local_group_size(16, 16)
    .sampler(0, ImageType::FLOAT_2D, "input_tx")
