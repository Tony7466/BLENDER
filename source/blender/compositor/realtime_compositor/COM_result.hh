...
class Result {
 ...
 public:
  /* A texture storing the result data. This will be a 1x1 texture if the result is a single
 ...
 public:
  ...
  Result(Context &context, DataType type, DataPrecision precision);
  ...
  /* Decrement the reference count of the result and release its texture if the reference count
