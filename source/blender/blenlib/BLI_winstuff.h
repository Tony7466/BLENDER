...
/* Gets the version of the currently loaded DirectX driver for the first device that matches deviceString
 * This is required for Qualcomm devices which use Mesa's Gallium D2D12 layer for OpenGL functionality */
