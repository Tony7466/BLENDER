...
ModifierData *BKE_modifiers_findby_identifier(const Object *ob, int identifier);
void BKE_modifiers_clear_errors(Object *ob);

/**
 * Updates `md.identifier` so that it is a valid identifier (>=1) and is unique in the object.
 */
