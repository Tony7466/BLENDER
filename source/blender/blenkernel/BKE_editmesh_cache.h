...
void BKE_editmesh_cache_ensure_face_normals(struct BMEditMesh *em, EditMeshData *emd);
void BKE_editmesh_cache_ensure_vert_normals(struct BMEditMesh *em, EditMeshData *emd);

void BKE_editmesh_cache_ensure_face_centers(struct BMEditMesh *em, EditMeshData *emd);
