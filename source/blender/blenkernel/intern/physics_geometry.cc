...
{
  return AttributeAccessor(this, bke::get_physics_accessor_functions_ref(true));
}

MutableAttributeAccessor PhysicsGeometry::attributes_for_write()
{
  return MutableAttributeAccessor(this, bke::get_physics_accessor_functions_ref(true));
}
