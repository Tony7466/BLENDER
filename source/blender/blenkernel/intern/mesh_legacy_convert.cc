...
{
  bNodeTree *group = blender::bke::BKE_node_tree_add_in_lib(
  ...
  blender::bke::nodeAddLink(group,
              group_input_angle,
              blender::bke::nodeFindSocket(group_input_angle, SOCK_OUT, "Socket_2"),
              less_than_or_equal,
  ...
  blender::bke::nodeAddLink(group,
              group_input_mesh,
              blender::bke::nodeFindSocket(group_input_mesh, SOCK_OUT, "Socket_1"),
              shade_smooth_edge,
