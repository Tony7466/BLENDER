                                ...
                                Paint *paint_old)
{
  ...
  Brush *override_brush_tmp = nullptr;
  Brush **override_brush_p = paint ? &paint->tool_brush_bindings.main_brush : &override_brush_tmp;
  BKE_LIB_FOREACHID_UNDO_PRESERVE_PROCESS_IDSUPER_P(data,
                                                    override_brush_p,
                                                    do_undo_restore,
                                                    SCENE_FOREACH_UNDO_RESTORE,
                                                    reader,
                                                    &paint_old->tool_brush_bindings.main_brush,
                                                    IDWALK_CB_NOP);
