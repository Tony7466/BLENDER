...
class BulletPhysicsWorldData : NonCopyable, NonMovable {
 public:
 ...
 public:
  BulletPhysicsWorldData();
  BulletPhysicsWorldData(int body_num, int constraint_num);
  ~BulletPhysicsWorldData();
...
// class PhysicsWorldData : public BulletPhysicsWorldData {
//   using BulletPhysicsWorldData::BulletPhysicsWorldData;
// };
