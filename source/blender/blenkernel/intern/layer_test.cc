...
namespace blender::bke::tests
{
  ...
  TEST(view_layer, aov_conflict)
  {
    ...
    test_render_pass_conflict(
        &scene, engine, view_layer, aov, "DiffDir", "use_pass_diffuse_direct");
    test_render_pass_conflict(
        &scene, engine, view_layer, aov, "DiffCol", "use_pass_diffuse_color");
    test_render_pass_conflict(
        &scene, engine, view_layer, aov, "GlossDir", "use_pass_glossy_direct");
    test_render_pass_conflict(
        &scene, engine, view_layer, aov, "GlossCol", "use_pass_glossy_color");
