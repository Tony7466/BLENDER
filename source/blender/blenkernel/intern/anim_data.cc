...
static void fcurves_apply_cb(ID *id, ListBase *fcurves, FunctionRef<void(ID *, FCurve *)> func)
{
...
static void nlastrips_apply_all_curves_cb(ID *id,
                                          ListBase *strips,
                                          FunctionRef<void(ID *, FCurve *)> func)
{
  LISTBASE_FOREACH (NlaStrip *, strip, strips) {
    /* fix strip's action */
    if (strip->act) {
...
static void adt_apply_all_fcurves_cb(ID *id, AnimData *adt, FunctionRef<void(ID *, FCurve *)> func)
{
  if (adt->action) {
...
void BKE_fcurves_id_cb(ID *id, FunctionRef<void(ID *, FCurve *)> func)
{
  AnimData *adt = BKE_animdata_from_id(id);
  if (adt != nullptr) {
...
void BKE_animdata_main_cb(Main *bmain, blender::FunctionRef<void(ID *, AnimData *)> func)
{
  ID *id;
