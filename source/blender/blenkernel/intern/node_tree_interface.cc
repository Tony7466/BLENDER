...
bool bNodeTreeInterfacePanel::remove_item(bNodeTreeInterfaceItem &item)
{
...
{
  return remove_item(root_panel, item);
}

bool bNodeTreeInterface::remove_item(bNodeTreeInterfacePanel &parent, bNodeTreeInterfaceItem &item)
{
