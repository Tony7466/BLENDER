...
void BKE_main_collection_sync_remap(const Main *bmain)
{
       ...
       scene = static_cast<Scene *>(scene->id.next))
  {
    ...
    DEG_id_tag_update_ex((Main *)bmain, &scene->master_collection->id, ID_RECALC_EVALUATED_COPY);
    DEG_id_tag_update_ex((Main *)bmain, &scene->id, ID_RECALC_EVALUATED_COPY);
  }
  ...
  {
    DEG_id_tag_update_ex((Main *)bmain, &collection->id, ID_RECALC_EVALUATED_COPY);
  }
