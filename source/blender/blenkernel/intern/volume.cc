...
float4x4 BKE_volume_vdb_transform_to_matrix(const openvdb::math::Transform &transform)
{
...
openvdb::math::Transform::Ptr BKE_volume_matrix_to_vdb_transform(const float4x4 &mat)
{
