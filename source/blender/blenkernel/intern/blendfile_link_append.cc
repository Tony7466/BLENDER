...
void BKE_blendfile_link_append_context_init_done(BlendfileLinkAppendContext *lapp_context)
{
  ...
  PointerRNA ctx_ptr = RNA_pointer_create(nullptr, &RNA_LinkAppendContext, lapp_context);
  PointerRNA *pointers[1] = {&ctx_ptr};
  BKE_callback_exec(lapp_context->params->bmain, pointers, 1, BKE_CB_EVT_LINKAPPEND_PRE);
}
...
void BKE_blendfile_link_append_context_finalize(BlendfileLinkAppendContext *lapp_context)
{
  ...
  PointerRNA ctx_ptr = RNA_pointer_create(nullptr, &RNA_LinkAppendContext, lapp_context);
  PointerRNA *pointers[1] = {&ctx_ptr};
  BKE_callback_exec(lapp_context->params->bmain, pointers, 1, BKE_CB_EVT_LINKAPPEND_POST);
}
