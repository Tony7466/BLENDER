                                                   ...
                                                   GreasePencilDrawing &r_drawing)
{
  ...
  LISTBASE_FOREACH_INDEX (bGPDstroke *, gps, &gpf.strokes, stroke_i) {
     ...
     * hardness). Now we store this value directly. This also matches the default for float
     * attributes. */
    stroke_hardnesses.span[stroke_i] = math::clamp(1.0f - gps->hardness, 0.0f, 1.0f);
