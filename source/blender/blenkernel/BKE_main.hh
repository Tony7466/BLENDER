...
struct Main {
  ...
  /**
   * This file was written by the asset system with the #G_FILE_MINIMAL_ASSET_EDIT_FILE flag (now
   * cleared). It must not be overwritten, except by the asset system itself. Otherwise the file
   * could end up with user created data that would be lost when the asset system regenerates the
   * file.
   */
