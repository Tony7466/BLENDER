...
class Geometry : public SocketDeclaration {
 private:
  blender::Vector<bke::GeometryComponentType> supported_types_;
 ...
 public:
  ...
  Span<bke::GeometryComponentType> supported_types() const;
...
class GeometryBuilder : public SocketDeclarationBuilder<Geometry> {
 public:
  GeometryBuilder &supported_type(bke::GeometryComponentType supported_type);
  GeometryBuilder &supported_type(blender::Vector<bke::GeometryComponentType> supported_types);
