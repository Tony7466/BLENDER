...
DefNode(ShaderNode,     SH_NODE_LINEAR_SYSTEM_SOLVER,       def_linear_system_solver,          "LINEAR_SYSTEM_SOLVER",      LinearSystemSolver,         "Linear System Solver",         "Solve the linear system of equations Ax=b for x")
