...
DefNode(GeometryNode, GEO_NODE_CLOSURE_OUTPUT, 0, "CLOSURE_OUTPUT", ClosureOutput, "Closure Output", "")
...
DefNode(GeometryNode, GEO_NODE_COMBINE_BUNDLE, 0, "COMBINE_BUNDLE", CombineBundle, "Combine Bundle", "Combine multiple values into one")
...
DefNode(GeometryNode, GEO_NODE_EVALUATE_CLOSURE, 0, "EVALUATE_CLOSURE", EvaluateClosure, "Evaluate Closure", "Evaluate a closure function")
...
DefNode(GeometryNode, GEO_NODE_SEPARATE_BUNDLE, 0, "SEPARATE_BUNDLE", SeparateBundle, "Separate Bundle", "Unpack a bundle into individual values")
