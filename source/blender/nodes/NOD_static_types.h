...
DefNode(GeometryNode, GEO_NODE_INPUT_BODY_ACTIVATION_STATE, 0, "INPUT_BODY_ACTIVATION_STATE", InputBodyActivationState, "Activation State", "Current activation state of a body in the simulation")
DefNode(GeometryNode, GEO_NODE_INPUT_BODY_PHYSICS_MODE, 0, "INPUT_BODY_PHYSICS_MODE", InputBodyPhysicsMode, "Physics Mode", "Physics simulation modes for rigid bodies")
