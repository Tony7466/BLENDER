...
DefNode(GeometryNode, GEO_NODE_COMBINE_GRID_TOPOLOGY, 0, "COMBINE_GRID_TOPOLOGY", CombineGridTopology, "Combine Grid Topology", "Combine topology of multiple grids")
...
DefNode(GeometryNode, GEO_NODE_GRID_CAPTURE, 0, "GRID_CAPTURE", GridCapture, "Capture Grid", "Evaluate the input field for every voxel of the topology grid and store values in a new grid")
...
DefNode(GeometryNode, GEO_NODE_SAMPLE_GRID, 0, "SAMPLE_GRID", SampleGrid, "Sample Grid", "Sample values from a volume grid at positions")
