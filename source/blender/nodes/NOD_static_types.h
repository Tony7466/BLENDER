...
DefNode(GeometryNode, GEO_NODE_SPLIT_CURVES, 0, "SPLIT_CURVES", SplitCurves, "Split Curves", "Create breaks between specified curve points, optionally removing segments")
