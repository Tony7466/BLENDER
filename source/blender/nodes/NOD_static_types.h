...
DefNode(FunctionNode, FN_NODE_MATRIX_ADD, 0, "MATRIX_ADD", MatrixAdd, "Add Matrices", "")
DefNode(FunctionNode, FN_NODE_MATRIX_SUBTRACT, 0, "MATRIX_SUBTRACT", MatrixSubtract, "Subtract Matrices", "")
DefNode(FunctionNode, FN_NODE_MATRIX_NORMALIZE, 0, "MATRIX_NORMALIZE", MatrixNormalize, "Normalize Matrix", "")
DefNode(FunctionNode, FN_NODE_MATRIX_DETERMINANT, 0, "MATRIX_DETERMINANT", MatrixDeterminant, "Matrix Determinant", "")
DefNode(FunctionNode, FN_NODE_MATRIX_ADJOINT, 0, "MATRIX_ADJOINT", MatrixAdjoint, "Adjoint Matrix", "")
