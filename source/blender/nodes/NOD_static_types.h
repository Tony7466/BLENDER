...
DefNode(GeometryNode, GEO_NODE_INPUT_SCENE_SOUND, 0, "INPUT_SCENE_SOUND", InputSceneSound, "Scene Sound", "Retrieve the context sound information in the scene's animation")
