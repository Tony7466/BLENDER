...
DefNode(GeometryNode, GEO_NODE_DISTRIBUTE_POINTS_ON_FACES, 0, "DISTRIBUTE_POINTS_ON_FACES", DistributePointsOnFaces, "Distribute Points on Faces", "Generate points spread out on the surface of a mesh")
...
DefNode(GeometryNode, GEO_NODE_FILLET_CURVE, 0et, "FILLET_CURVE", FilletCurve, "Fillet Curve", "Round corners by generating circular arcs on each control point")
...
DefNode(GeometryNode, GEO_NODE_IMAGE_TEXTURE, 0_texture, "IMAGE_TEXTURE", ImageTexture, "Image Texture", "Sample values from an image texture")
...
DefNode(GeometryNode, GEO_NODE_IMAGE, 0, "IMAGE", InputImage, "Image", "Input image")
...
DefNode(GeometryNode, GEO_NODE_INPUT_MATERIAL, 0, "INPUT_MATERIAL", InputMaterial, "Material", "Output a single material")
...
DefNode(GeometryNode, GEO_NODE_REPEAT_OUTPUT, 0, "REPEAT_OUTPUT", RepeatOutput, "Repeat Output", "")
...
DefNode(GeometryNode, GEO_NODE_STRING_TO_CURVES, 0, "STRING_TO_CURVES", StringToCurves, "String to Curves", "Generate a paragraph of text with a specific font, using a curve instance to store each character")
