...
DefNode(GeometryNode, GEO_NODE_EVALUATE_FOR_BLUR, def_geo_blur_attribute, "EVALUATE_FOR_BLUR", BlurAttribute, "Evaluate for Blur", "Mix field values of neighboring elements")
