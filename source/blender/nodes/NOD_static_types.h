...
DefNode(GeometryNode, GEO_NODE_CURVE_HANDLE_TYPE_SELECTION, 0, "CURVE_HANDLE_TYPE_SELECTION", CurveHandleTypeSelection, "Handle Type Selection", "Provide a selection based on the handle types of Bézier control points")
...
DefNode(GeometryNode, GEO_NODE_CURVE_SET_HANDLE_TYPE, 0, "CURVE_SET_HANDLES", CurveSetHandles, "Set Handle Type", "Set the handle type for the control points of a Bézier curve")
...
DefNode(GeometryNode, GEO_NODE_SAMPLE_CURVE, 0, "SAMPLE_CURVE", SampleCurve, "Sample Curve", "Retrieve data from a point on a curve at a certain distance from its start")
DefNode(GeometryNode, GEO_NODE_SAMPLE_INDEX, 0, "SAMPLE_INDEX", SampleIndex, "Sample Index", "Retrieve values from specific geometry elements")
