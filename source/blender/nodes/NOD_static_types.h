...
DefNode(FunctionNode, FN_NODE_COMBINE_QUATERNION, 0, "COMBINE_QUATERNION", CombineQuaternion, "Combine Quaternion", "")
...
DefNode(FunctionNode, FN_NODE_SEPARATE_QUATERNION, 0, "SEPARATE_QUATERNION", SeparateQuaternion, "Separate Quaternion", "")
