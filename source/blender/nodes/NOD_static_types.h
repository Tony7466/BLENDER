...
DefNode(GeometryNode, GEO_NODE_MEAN_FILTER_SDF_VOLUME, 0, "MEAN_FILTER_SDF_VOLUME", MeanFilterSdfVolume, "Mean Filter SDF Volume", "Apply a Mean Filter to an SDF Volume")
...
DefNode(GeometryNode, GEO_NODE_OFFSET_SDF_VOLUME, 0, "OFFSET_SDF_VOLUME", OffsetSdfVolume, "Offset SDF Volume", "Apply an offset to an SDF Volume")
