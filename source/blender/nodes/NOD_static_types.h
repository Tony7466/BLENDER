...
DefNode(GeometryNode, GEO_NODE_OPERATOR_FACE_SET, 0, "OPERATOR_FACE_SET", OperatorFaceSet, "Face Set", "Each face's sculpt face set value")
...
DefNode(GeometryNode, GEO_NODE_OPERATOR_SELECTION, 0, "OPERATOR_SELECTION", OperatorSelection, "Selection", "User selection of the edited geometry, for tool execution")
DefNode(GeometryNode, GEO_NODE_OPERATOR_SET_SELECTION, def_geo_operator_set_selection, "OPERATOR_SELECTION_SET", OperatorSetSelection, "Set Selection", "Set selection of the edited geometry, for tool execution")
DefNode(GeometryNode, GEO_NODE_OPERATOR_SET_FACE_SET, 0, "OPERATOR_SET_FACE_SET", OperatorSetFaceSet, "Set Face Set", "Set sculpt face set values for faces")
