...
DefNode(GeometryNode, GEO_NODE_SDF_GRID_DIFFERENCE, 0, "SDF_GRID_DIFFERENCE", SDFGridDifference, "SDF Grid Difference", "Subtract the volume of one SDF grid from another")
DefNode(GeometryNode, GEO_NODE_SDF_GRID_INTERSECTION, 0, "SDF_GRID_INTERSECTION", SDFGridIntersection, "SDF Grid Intersection", "Calculate the common volume contained in all SDF grid inputs")
DefNode(GeometryNode, GEO_NODE_SDF_GRID_UNION, 0, "SDF_GRID_UNION", SDFGridUnion, "SDF Grid Union", "Calculate the combined volume of multiple SDF grids")
