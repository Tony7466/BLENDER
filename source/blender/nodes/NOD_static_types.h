...
DefNode(GeometryNode, GEO_NODE_OPERATOR_SET_SELECTION, def_geo_operator_set_selection, "OPERATOR_SELECTION_SET", OperatorSetSelection, "Set Selection", "Set selection of the edited geometry, for operator execution")
