...
DefNode(GeometryNode, GEO_NODE_INPUT_GRID_COORDINATE, 0, "INPUT_GRID_COORDINATE", InputGridCoordinate, "Grid Coordinate", "Grid coordinate of the active voxels of a volume")
DefNode(GeometryNode, GEO_NODE_INPUT_GRID_VALUE, def_geo_input_grid_value, "INPUT_GRID_VALUE", InputGridValue, "Grid Value", "Value stored in the active voxels of a volume")
...
DefNode(GeometryNode, GEO_NODE_SET_GRID_VALUE, def_geo_set_grid_value, "SET_GRID_VALUE", SetGridValue, "Set Grid Value", "Set the value in the active voxels of a volume")
...
DefNode(GeometryNode, GEO_NODE_VOLUME_INFO, 0, "VOLUME_INFO", VolumeInfo, "Volume Info", "Properties of a volume grid")
DefNode(GeometryNode, GEO_NODE_VOLUME_DIVERGENCE, 0, "VOLUME_DIVERGENCE", VolumeDivergence, "Volume Divergence", "Compute the divergence of a vector grid")
DefNode(GeometryNode, GEO_NODE_VOLUME_GRADIENT, 0, "VOLUME_GRADIENT", VolumeGradient, "Volume Gradient", "Compute the gradient of a scalar grid")
DefNode(GeometryNode, GEO_NODE_VOLUME_SOLVE_POISSON, 0, "VOLUME_SOLVE_POISSON", VolumeSolvePoisson, "Volume Solve Poisson", "Solve a Poisson equation on a grid")
