...
DefNode(GeometryNode, GEO_NODE_BUNDLE, 0, "BUNDLE", Bundle, "Bundle", "Combine multiple values into one")
...
DefNode(GeometryNode, GEO_NODE_UNBUNDLE, 0, "UNBUNDLE", Unbundle, "Unbundle", "Unpack a bundle into individual values")
