...
DefNode(ShaderNode,     SH_NODE_BSDF_CONDUCTOR,        def_conductor,             "BSDF_CONDUCTOR",        BsdfConductor,  "Conductor BSDF",       "Metallic reflection with microfacet distribution, and metallic fresnel")
