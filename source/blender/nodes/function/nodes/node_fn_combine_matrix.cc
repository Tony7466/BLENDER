...
static void node_declare(NodeDeclarationBuilder &b)
{
  ...
  column_a.add_input<decl::Float>("A", "Column A Row A").default_value(1.0f);
  column_a.add_input<decl::Float>("B", "Column A Row B");
  column_a.add_input<decl::Float>("C", "Column A Row C");
  column_a.add_input<decl::Float>("D", "Column A Row D");

  PanelDeclarationBuilder &column_b = b.add_panel("Column B").default_closed(true);
  column_b.add_input<decl::Float>("A", "Column B Row A");
  column_b.add_input<decl::Float>("B", "Column B Row B").default_value(1.0f);
  column_b.add_input<decl::Float>("C", "Column B Row C");
  column_b.add_input<decl::Float>("D", "Column B Row D");

  PanelDeclarationBuilder &column_c = b.add_panel("Column C").default_closed(true);
  column_c.add_input<decl::Float>("A", "Column C Row A");
  column_c.add_input<decl::Float>("B", "Column C Row B");
  column_c.add_input<decl::Float>("C", "Column C Row C").default_value(1.0f);
  column_c.add_input<decl::Float>("D", "Column C Row D");

  PanelDeclarationBuilder &column_d = b.add_panel("Column D").default_closed(true);
  column_d.add_input<decl::Float>("A", "Column D Row A");
