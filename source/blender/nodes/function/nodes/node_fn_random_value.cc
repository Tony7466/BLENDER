...
static void fn_node_random_value_update(bNodeTree *ntree, bNode *node)
{
  ...
  blender::bke::nodeSetSocketAvailability(ntree, sock_min_vector, data_type == CD_PROP_FLOAT3);
  blender::bke::nodeSetSocketAvailability(ntree, sock_max_vector, data_type == CD_PROP_FLOAT3);
  blender::bke::nodeSetSocketAvailability(ntree, sock_min_float, data_type == CD_PROP_FLOAT);
  blender::bke::nodeSetSocketAvailability(ntree, sock_max_float, data_type == CD_PROP_FLOAT);
  blender::bke::nodeSetSocketAvailability(ntree, sock_min_int, data_type == CD_PROP_INT32);
  blender::bke::nodeSetSocketAvailability(ntree, sock_max_int, data_type == CD_PROP_INT32);
  blender::bke::nodeSetSocketAvailability(ntree, sock_probability, data_type == CD_PROP_BOOL);
