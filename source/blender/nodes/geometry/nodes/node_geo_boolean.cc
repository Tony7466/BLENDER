...
static void node_update(bNodeTree *ntree, bNode *node)
{
  ...
  switch (operation) {
    ...
    case GEO_NODE_BOOLEAN_UNION:
      blender::bke::nodeSetSocketAvailability(ntree, geometry_1_socket, false);
      blender::bke::nodeSetSocketAvailability(ntree, geometry_2_socket, true);
      node_sock_label(geometry_2_socket, N_("Mesh"));
      break;
    case GEO_NODE_BOOLEAN_DIFFERENCE:
      blender::bke::nodeSetSocketAvailability(ntree, geometry_1_socket, true);
      blender::bke::nodeSetSocketAvailability(ntree, geometry_2_socket, true);
