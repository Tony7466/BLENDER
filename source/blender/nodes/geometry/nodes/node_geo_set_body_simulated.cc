...
namespace blender::nodes::node_geo_set_body_simulated_cc {
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  Field<bool> simulated_field = params.extract_input<Field<bool>>("Simulated");
...
static void node_register()
{
  ...
  geo_node_type_base(
      &ntype, GEO_NODE_SET_BODY_SIMULATED, "Set Body Simulated", NODE_CLASS_GEOMETRY);
