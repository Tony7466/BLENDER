                             ...
                             const AnonymousAttributePropagationInfo &propagation_info)
{
  ...
  geometry_set.keep_only_during_modify({bke::GEO_COMPONENT_TYPE_CURVE});
...
static void duplicate_points(GeometrySet &geometry_set,
                             ...
                             const AnonymousAttributePropagationInfo &propagation_info)
{
  Vector<bke::GeometryComponentType> component_types = geometry_set.gather_component_types(true,
                                                                                           true);
  for (const bke::GeometryComponentType component_type : component_types) {
  ...
  component_types.append(bke::GEO_COMPONENT_TYPE_INSTANCES);
