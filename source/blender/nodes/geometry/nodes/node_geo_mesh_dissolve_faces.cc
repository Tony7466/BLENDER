...
namespace blender::nodes::node_geo_mesh_dissolve_faces_cc {
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  geometry_set.modify_geometry_sets([&](GeometrySet &geometry_set) {
    ...
    geometry_set.replace_mesh(geometry::dissolve_faces(*src_mesh, mask, propagation_info));
  });
...
static void node_register()
{
  ...
  geo_node_type_base(&ntype, GEO_NODE_DISSOLVE_FACES, "Dissolve Faces", NODE_CLASS_GEOMETRY);
