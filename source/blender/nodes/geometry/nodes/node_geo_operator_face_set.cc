...
namespace blender::nodes::node_geo_operator_face_set_cc {
...
void register_node_type_geo_operator_face_set()
{
  namespace file_ns = blender::nodes::node_geo_operator_face_set_cc;
  static bNodeType ntype;
  geo_node_type_base(&ntype, GEO_NODE_OPERATOR_FACE_SET, "Face Set", NODE_CLASS_INPUT);
