...
namespace blender::nodes::node_geo_set_body_kinematic_cc {

static void node_declare(NodeDeclarationBuilder &b)
{
  b.add_input<decl::Geometry>("Physics").supported_type(bke::GeometryComponent::Type::Physics);
  b.add_input<decl::Bool>("Selection").default_value(true).hide_value().field_on_all();
  b.add_input<decl::Bool>("Kinematic").default_value(true).field_on_all();
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  Field<bool> kinematic_field = params.extract_input<Field<bool>>("Kinematic");
...
static void node_register()
{
  ...
  geo_node_type_base(
      &ntype, GEO_NODE_SET_BODY_KINEMATIC, "Set Body Kinematic", NODE_CLASS_GEOMETRY);
