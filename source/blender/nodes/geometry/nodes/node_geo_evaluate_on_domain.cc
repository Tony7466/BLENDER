...
static void node_update(bNodeTree *ntree, bNode *node)
{
  ...
  blender::bke::nodeSetSocketAvailability(ntree, sock_in_float, data_type == CD_PROP_FLOAT);
  blender::bke::nodeSetSocketAvailability(ntree, sock_in_int, data_type == CD_PROP_INT32);
  blender::bke::nodeSetSocketAvailability(ntree, sock_in_vector, data_type == CD_PROP_FLOAT3);
  blender::bke::nodeSetSocketAvailability(ntree, sock_in_color, data_type == CD_PROP_COLOR);
  blender::bke::nodeSetSocketAvailability(ntree, sock_in_bool, data_type == CD_PROP_BOOL);

  blender::bke::nodeSetSocketAvailability(ntree, sock_out_float, data_type == CD_PROP_FLOAT);
  blender::bke::nodeSetSocketAvailability(ntree, sock_out_int, data_type == CD_PROP_INT32);
  blender::bke::nodeSetSocketAvailability(ntree, sock_out_vector, data_type == CD_PROP_FLOAT3);
  blender::bke::nodeSetSocketAvailability(ntree, sock_out_color, data_type == CD_PROP_COLOR);
  blender::bke::nodeSetSocketAvailability(ntree, sock_out_bool, data_type == CD_PROP_BOOL);
}
