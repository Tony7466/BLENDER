...
static void node_update(bNodeTree *ntree, bNode *node)
{
  ...
  blender::bke::nodeSetSocketAvailability(ntree, start_socket, points_mode);
  blender::bke::nodeSetSocketAvailability(ntree, middle_socket, points_mode);
  blender::bke::nodeSetSocketAvailability(ntree, end_socket, points_mode);

  blender::bke::nodeSetSocketAvailability(ntree, radius_socket, radius_mode);
  blender::bke::nodeSetSocketAvailability(ntree, start_angle_socket, radius_mode);
  blender::bke::nodeSetSocketAvailability(ntree, sweep_angle_socket, radius_mode);

  blender::bke::nodeSetSocketAvailability(ntree, offset_angle_socket, points_mode);

  blender::bke::nodeSetSocketAvailability(ntree, center_out_socket, points_mode);
  blender::bke::nodeSetSocketAvailability(ntree, normal_out_socket, points_mode);
  blender::bke::nodeSetSocketAvailability(ntree, radius_out_socket, points_mode);
}
