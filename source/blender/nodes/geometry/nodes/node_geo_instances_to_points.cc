                                        ...
                                        const AnonymousAttributePropagationInfo &propagation_info)
{
  ...
  geometry_set.gather_attributes_for_propagation({bke::GEO_COMPONENT_TYPE_INSTANCES},
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  if (geometry_set.has_instances()) {
    ...
    geometry_set.keep_only({bke::GEO_COMPONENT_TYPE_POINT_CLOUD, bke::GEO_COMPONENT_TYPE_EDIT});
