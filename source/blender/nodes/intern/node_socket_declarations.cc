...
Span<bke::GeometryComponentType> Geometry::supported_types() const
{
...
GeometryBuilder &GeometryBuilder::supported_type(bke::GeometryComponentType supported_type)
{
...
GeometryBuilder &GeometryBuilder::supported_type(
    blender::Vector<bke::GeometryComponentType> supported_types)
{
