...
{
  const VkPipelineStageFlags supportedShaderBits = VK_PIPELINE_STAGE_VERTEX_INPUT_BIT |
...
const VkAccessFlagBits acs_general1 =
    (VkAccessFlagBits)(VK_ACCESS_SHADER_READ_BIT | VK_ACCESS_SHADER_WRITE_BIT |
                       VK_ACCESS_MEMORY_READ_BIT | VK_ACCESS_MEMORY_WRITE_BIT |
                       VK_ACCESS_TRANSFER_READ_BIT | VK_ACCESS_TRANSFER_WRITE_BIT);
const VkAccessFlagBits acs_general = (VkAccessFlagBits)(VK_ACCESS_SHADER_READ_BIT |
                                                        VK_ACCESS_SHADER_WRITE_BIT);
