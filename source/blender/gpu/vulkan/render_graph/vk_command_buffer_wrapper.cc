...
#define LOG \
  std::cout << "VKCommandBufferWrapper::" << __func__ << ": thread=" << pthread_self() \
            << ", main=" << BLI_thread_is_main() << "\n";
