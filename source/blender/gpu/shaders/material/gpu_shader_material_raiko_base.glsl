...
vec3 calculate_out_fields_2d_irregular_elliptical(
                                                  bool calculate_r_gon_parameter_field,
...
vec3 calculate_out_fields_2d_irregular_circular(
                                                bool calculate_r_gon_parameter_field,
                                                bool calculate_max_unit_parameter,
                                                bool normalize_r_gon_parameter,
                                                float r_gon_sides,
                             ...
                             vec2 coord)
{
  ...
  if (fract(r_gon_sides) == 0.0) {
    ...
    if (r_gon_roundness == 1.0) {
      ...
      if (elliptical_corners) {
        return calculate_out_fields_2d_irregular_elliptical(
                                                            calculate_r_gon_parameter_field,
                                                            calculate_max_unit_parameter,
                                                            normalize_r_gon_parameter,
                                                            r_gon_sides,
        ...
        return calculate_out_fields_2d_irregular_circular(
                                                          calculate_r_gon_parameter_field,
                                                          calculate_max_unit_parameter,
                                                          normalize_r_gon_parameter,
                                                          r_gon_sides,
...
vec3 calculate_out_fields_4d(
                             ...
                             vec4 coord)
{
  vec3 out_fields = calculate_out_fields_2d(
                                            calculate_r_gon_parameter_field,
                                            calculate_max_unit_parameter,
                                            normalize_r_gon_parameter,
                                            elliptical_corners,
...
void node_tex_raiko_base(vec3 in_coord,
                    float in_w,
                    float in_scale,
                    float in_r_gon_sides,
                    float in_r_gon_roundness,
                    float in_r_gon_exponent,
                    float in_sphere_exponent,
                    float in_normalize_r_gon_parameter,
                    float in_elliptical_corners,
                    float in_calculate_r_gon_parameter_field,
                    float in_calculate_max_unit_parameter,
                    out float out_r_sphere_field,
                    out float out_r_gon_parameter_field,
                    out float out_max_unit_parameter)
{
  vec3 out_variables = calculate_out_fields_4d(
                                               bool(in_calculate_r_gon_parameter_field),
                                               bool(in_calculate_max_unit_parameter),
                                               bool(in_normalize_r_gon_parameter),
                                               bool(in_elliptical_corners),
                                               max(in_r_gon_sides,2.0),
                                               clamp(in_r_gon_roundness,0.0,1.0),
                                               max(in_r_gon_exponent,0.0),
                                               max(in_sphere_exponent,0.0),
      in_scale * vec4(in_coord.x, in_coord.y, in_coord.z, in_w));
