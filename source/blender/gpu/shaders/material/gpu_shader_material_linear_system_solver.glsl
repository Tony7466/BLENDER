                               ...
                               out float out_solution_w)
{
  switch (int(matrix_dimension)) {
    ...
    case 2: {
      ...
      if (M_det != 0.0) {
        vec2 solution_xy = rc_linear_system_solve_non_singular_2x2(vec2(column_1.x, column_1.y),
    ...
    case 4: {
      rcc_4x4 A_rcc = calculate_rcc_4x4(vec4(column_1.x, column_1.y, column_1.z, column_1_w),
