...
GLuint GLShader::compile_stage_using_driver(GLenum gl_stage,
...
{
  // TODO(jbakker): spirv supports specialization constants. This was introduced to Blender
  // recently, but wasn't added to the spir-v parts of the GPUBackend.
                                     ...
                                     const GLSources &gl_sources)
{
  ...
  if (GLContext::spir_v_support) {
    ...
    shader = compile_stage_using_driver(gl_stage, sources, gl_sources);
  }
