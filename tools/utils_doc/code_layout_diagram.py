...
./blender.bin -b --python ./tools/utils_doc/code_layout_diagram.py


This is an older version of the graphic: https://www.blender.org/bf/codelayout.jpg

bash -c 'while true; do inotifywait -e close_write ./tools/utils_doc/code_layout_diagram.py ; tput clear ; ./blender.bin -b --python ./tools/utils_doc/code_layout_diagram.py ; done'
"""
...
FONT_FILE_DEFAULT = os.path.join(ROOT_DIR, "release", "datafiles", "fonts", "DejaVuSans.woff2")
...
SECTIONS = (
    ...
    SectionData(
        ...
        source_code_dirs=[
            ...
            ("gpencil", "Tools for editing grease pencil object types."),
    ...
    SectionData(
        ...
        source_code_dirs=[
            ...
            ("gpencil_modifiers", "Grease pencil modifiers."),
    ...
    SectionData(
        ...
        source_code_dirs=[
            ...
            ("locale", "Internationalization support for translating the user interface."),
    ...
    SectionData(
        ...
        source_code_dirs=[
            ...
            ("clew", "Extension wrangler for OpenCL."),
            ...
            ("sdlew", "SDL wrangler (dynamic loader)."),
            ("smaa_areatex", "Enhanced sub-pixel anti-aliasing. Used by the anti-aliasing compositor node."),
    ...
    SectionData(
        ...
        source_code_dirs=[
            ...
            ("blosc", "Compression library. Used by OpenVDB."),
            ("boost", "Additional C++ libraries & utilities."),
...
def draw_mesh_box(bm, *, box, material_index=0):
    quad = [bm.verts.new() for i in range(4)]
...
def draw_sub_section(scene, *, step_y, section_data, is_last):
    box_sub_heading, _ = draw_text_centered(scene, location=(
        0.0, step_y), text=section_data.heading, style=text_style_subheading)
...
def render_output(scene, bounds, filepath):
    ...
    if OUTPUT_IMAGE_FILE:
        ...
        print(bpy.ops.render.render.poll())
...
def main():
    ...
    # TODO: support the output as a command line argument.
    print(os.path.join(ROOT_DIR, "code_layout.webp"))
    render_output(scene, bounds, os.path.join(ROOT_DIR, "code_layout.webp"))
