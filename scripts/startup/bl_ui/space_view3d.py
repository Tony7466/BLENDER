...
class VIEW3D_MT_face_sets(Menu):
    ...
    def draw(self, _context):
        ...
        props = layout.operator("sculpt.face_set_edit", text="Fair Face Set Positions")
        props.mode = 'FAIR_POSITIONS'

        props = layout.operator("sculpt.face_set_edit", text="Fair Face Set Tangency")
        props.mode = 'FAIR_TANGENCY'
        ...
        props = layout.operator("sculpt.face_sets_randomize_colors", text="Random Face Set Colors")
