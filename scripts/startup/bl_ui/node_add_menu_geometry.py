...
class NODE_MT_category_utilities_matrix(Menu):
    ...
    def draw(self, _context):
        ...
        node_add_menu.add_node_type(layout, "FunctionNodeMatrixAdd")
        node_add_menu.add_node_type(layout, "FunctionNodeMatrixSubtract")
        node_add_menu.add_node_type(layout, "FunctionNodeMatrixNormalize")
        node_add_menu.add_node_type(layout, "FunctionNodeMatrixDeterminant")
        node_add_menu.add_node_type(layout, "FunctionNodeMatrixAdjoint")
