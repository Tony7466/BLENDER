...
class GreasePencil_MT_group_context_menu(Menu):
    ...
    def draw(self, context):
        layout = self.layout
        layout.operator("grease_pencil.layer_group_remove", text="Delete Group").remove_child = False
        layout.operator("grease_pencil.layer_group_remove", text="Delete Group and children").remove_child = True
