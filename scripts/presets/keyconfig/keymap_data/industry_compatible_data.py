...
def km_grease_pencil_stroke_paint_mode(params):
    ...
    items.extend([
        # Navigation
        ("view3d.view_center_pick", {"type": 'F', "value": 'CLICK'}, None),
        # Brush strength
...
def km_face_mask(params):
    ...
    items.extend([
        ...
        ("paint.vert_select_linked_pick", {"type": 'LEFTMOUSE', "value": 'DOUBLE_CLICK', "shift": True, "alt": True},
...
def km_image_paint(params):
    ...
    items.extend([
        ...
        *_template_paint_radial_control("image_paint", color=True, zoom=True, rotation=True, secondary_rotation=True),
        # Stencil Controls
        ("brush.stencil_control", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True, "modifier_key": 'Z'},
         {"properties": [("mode", 'TRANSLATION')]}),
        ("brush.stencil_control", {"type": 'RIGHTMOUSE', "value": 'PRESS', "shift": True, "modifier_key": 'Z'},
         {"properties": [("mode", 'SCALE')]}),
        ("brush.stencil_control", {"type": 'LeftMouse', "value": 'PRESS', "shift": True, "modifier_key": 'Z'},
         {"properties": [("mode", 'ROTATION')]}),
        ("brush.stencil_control", {"type": 'MIDDLEMOUSE', "value": 'PRESS', "shift": True, "alt": True, "modifier_key": 'Z'},
         {"properties": [("mode", 'TRANSLATION'), ("texmode", 'SECONDARY')]}),
        ("brush.stencil_control", {"type": 'RIGHTMOUSE', "value": 'PRESS', "shift": True, "alt": True, "modifier_key": 'Z'},
         {"properties": [("mode", 'SCALE'), ("texmode", 'SECONDARY')]}),
        ("brush.stencil_control", {"type": 'LeftMouse', "value": 'PRESS', "shift": True, "alt": True, "modifier_key": 'Z'},
...
def km_sculpt(params):
    ...
    items.extend([
        ...
        ("sculpt.face_set_change_visibility", {"type": 'H', "value": 'PRESS', "ctrl": True},
    ...
    items.extend([
        ...
        *_template_paint_radial_control("curves_sculpt"),
        ...
        ("brush.scale_size", {"type": 'RIGHT_BRACKET', "value": 'PRESS', "repeat": True},
         {"properties": [("scalar", 1.0 / 0.9)]}),
        # Selection operators
        ("curves.select_all", {"type": 'A', "value": 'PRESS', "shift": True, "ctlr": True}, {"properties": [("action", 'DESELECT')]}),
