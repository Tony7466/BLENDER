...
def rmtree_with_fallback_or_error_pseudo_atomic(
    ...
    if isdir:
        ...
        while os.path.exists(path_test):
            ...
            if test_count > 1000:
                return "Unable to calculate a new at: {:s}".format(path_test)
        ...
        #   This is important because in the case of an upgrade we *never*
        #   want to leave the extension in a broken state - with some files removed and the directory locked,
        ...
        # so keep it to avoid important logic diverging.
        #
        # See #128175.
