...
def _extensions_repo_temp_files_make_stale(
    ...
    # We could communicate this using the packaging commands but it's reasonably involved.
    # Simply scan repository directories and clear files with a specific prefix & suffix.
    import addon_utils
