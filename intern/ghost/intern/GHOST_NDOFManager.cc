...
static const std::map<GHOST_NDOF_ButtonT, const char *> ndof_button_names = {
    MAP_ENTRY(NDOF_BUTTON_INVALID),  MAP_ENTRY(NDOF_BUTTON_MENU),
    MAP_ENTRY(NDOF_BUTTON_FIT),      MAP_ENTRY(NDOF_BUTTON_TOP),
    MAP_ENTRY(NDOF_BUTTON_LEFT),     MAP_ENTRY(NDOF_BUTTON_RIGHT),
    MAP_ENTRY(NDOF_BUTTON_FRONT),    MAP_ENTRY(NDOF_BUTTON_BOTTOM),
    MAP_ENTRY(NDOF_BUTTON_BACK),     MAP_ENTRY(NDOF_BUTTON_ROLL_CW),
    MAP_ENTRY(NDOF_BUTTON_ROLL_CCW), MAP_ENTRY(NDOF_BUTTON_SPIN_CW),
    MAP_ENTRY(NDOF_BUTTON_SPIN_CCW), MAP_ENTRY(NDOF_BUTTON_TILT_CW),
    MAP_ENTRY(NDOF_BUTTON_TILT_CCW), MAP_ENTRY(NDOF_BUTTON_ISO1),
    MAP_ENTRY(NDOF_BUTTON_ISO2),     MAP_ENTRY(NDOF_BUTTON_1),
    MAP_ENTRY(NDOF_BUTTON_2),        MAP_ENTRY(NDOF_BUTTON_3),
    MAP_ENTRY(NDOF_BUTTON_4),        MAP_ENTRY(NDOF_BUTTON_5),
    MAP_ENTRY(NDOF_BUTTON_6),        MAP_ENTRY(NDOF_BUTTON_7),
    MAP_ENTRY(NDOF_BUTTON_8),        MAP_ENTRY(NDOF_BUTTON_9),
    MAP_ENTRY(NDOF_BUTTON_10),       MAP_ENTRY(NDOF_BUTTON_11),
    MAP_ENTRY(NDOF_BUTTON_12),       MAP_ENTRY(NDOF_BUTTON_ESC),
    MAP_ENTRY(NDOF_BUTTON_ALT),      MAP_ENTRY(NDOF_BUTTON_SHIFT),
    MAP_ENTRY(NDOF_BUTTON_CTRL),     MAP_ENTRY(NDOF_BUTTON_ENTER),
    MAP_ENTRY(NDOF_BUTTON_DELETE),   MAP_ENTRY(NDOF_BUTTON_TAB),
    MAP_ENTRY(NDOF_BUTTON_SPACE),    MAP_ENTRY(NDOF_BUTTON_ROTATE),
    MAP_ENTRY(NDOF_BUTTON_PANZOOM),  MAP_ENTRY(NDOF_BUTTON_DOMINANT),
    MAP_ENTRY(NDOF_BUTTON_PLUS),     MAP_ENTRY(NDOF_BUTTON_MINUS),
    MAP_ENTRY(NDOF_BUTTON_V1),       MAP_ENTRY(NDOF_BUTTON_V2),
    MAP_ENTRY(NDOF_BUTTON_V3),       MAP_ENTRY(NDOF_BUTTON_SAVE_V1),
    MAP_ENTRY(NDOF_BUTTON_SAVE_V2),  MAP_ENTRY(NDOF_BUTTON_SAVE_V3),
    MAP_ENTRY(NDOF_BUTTON_KBP_F1),   MAP_ENTRY(NDOF_BUTTON_KBP_F2),
    MAP_ENTRY(NDOF_BUTTON_KBP_F3),   MAP_ENTRY(NDOF_BUTTON_KBP_F4),
    MAP_ENTRY(NDOF_BUTTON_KBP_F5),   MAP_ENTRY(NDOF_BUTTON_KBP_F6),
    MAP_ENTRY(NDOF_BUTTON_KBP_F7),   MAP_ENTRY(NDOF_BUTTON_KBP_F8),
    MAP_ENTRY(NDOF_BUTTON_KBP_F9),   MAP_ENTRY(NDOF_BUTTON_KBP_F10),
    MAP_ENTRY(NDOF_BUTTON_KBP_F11),  MAP_ENTRY(NDOF_BUTTON_KBP_F12),
