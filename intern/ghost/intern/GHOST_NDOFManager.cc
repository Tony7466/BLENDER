...
static const std::map<GHOST_NDOF_ButtonT, const char *> ndof_button_names = {
    ...
    {GHOST_NDOF_BUTTON_MENU, "NDOF_BUTTON_MENU"},
    {GHOST_NDOF_BUTTON_FIT, "NDOF_BUTTON_FIT"},
    {GHOST_NDOF_BUTTON_TOP, "NDOF_BUTTON_TOP"},
    {GHOST_NDOF_BUTTON_LEFT, "NDOF_BUTTON_LEFT"},
    {GHOST_NDOF_BUTTON_RIGHT, "NDOF_BUTTON_RIGHT"},
    {GHOST_NDOF_BUTTON_FRONT, "NDOF_BUTTON_FRONT"},
    {GHOST_NDOF_BUTTON_BOTTOM, "NDOF_BUTTON_BOTTOM"},
    {GHOST_NDOF_BUTTON_BACK, "NDOF_BUTTON_BACK"},
    {GHOST_NDOF_BUTTON_ROLL_CW, "NDOF_BUTTON_ROLL_CW"},
    {GHOST_NDOF_BUTTON_ROLL_CCW, "NDOF_BUTTON_ROLL_CCW"},
    {GHOST_NDOF_BUTTON_SPIN_CW, "NDOF_BUTTON_SPIN_CW"},
    {GHOST_NDOF_BUTTON_SPIN_CCW, "NDOF_BUTTON_SPIN_CCW"},
    {GHOST_NDOF_BUTTON_TILT_CW, "NDOF_BUTTON_TILT_CW"},
    {GHOST_NDOF_BUTTON_TILT_CCW, "NDOF_BUTTON_TILT_CCW"},
    {GHOST_NDOF_BUTTON_ISO1, "NDOF_BUTTON_ISO1"},
    {GHOST_NDOF_BUTTON_ISO2, "NDOF_BUTTON_ISO2"},
    {GHOST_NDOF_BUTTON_1, "NDOF_BUTTON_1"},
    {GHOST_NDOF_BUTTON_2, "NDOF_BUTTON_2"},
    {GHOST_NDOF_BUTTON_3, "NDOF_BUTTON_3"},
    {GHOST_NDOF_BUTTON_4, "NDOF_BUTTON_4"},
    {GHOST_NDOF_BUTTON_5, "NDOF_BUTTON_5"},
    {GHOST_NDOF_BUTTON_6, "NDOF_BUTTON_6"},
    {GHOST_NDOF_BUTTON_7, "NDOF_BUTTON_7"},
    {GHOST_NDOF_BUTTON_8, "NDOF_BUTTON_8"},
    {GHOST_NDOF_BUTTON_9, "NDOF_BUTTON_9"},
    {GHOST_NDOF_BUTTON_10, "NDOF_BUTTON_10"},
    {GHOST_NDOF_BUTTON_11, "NDOF_BUTTON_11"},
    {GHOST_NDOF_BUTTON_12, "NDOF_BUTTON_12"},
    {GHOST_NDOF_BUTTON_ESC, "NDOF_BUTTON_ESC"},
    {GHOST_NDOF_BUTTON_ALT, "NDOF_BUTTON_ALT"},
    {GHOST_NDOF_BUTTON_SHIFT, "NDOF_BUTTON_SHIFT"},
    {GHOST_NDOF_BUTTON_CTRL, "NDOF_BUTTON_CTRL"},
    {GHOST_NDOF_BUTTON_ENTER, "NDOF_BUTTON_ENTER"},
    {GHOST_NDOF_BUTTON_DELETE, "NDOF_BUTTON_DELETE"},
    {GHOST_NDOF_BUTTON_TAB, "NDOF_BUTTON_TAB"},
    {GHOST_NDOF_BUTTON_SPACE, "NDOF_BUTTON_SPACE"},
    {GHOST_NDOF_BUTTON_ROTATE, "NDOF_BUTTON_ROTATE"},
    {GHOST_NDOF_BUTTON_PANZOOM, "NDOF_BUTTON_PANZOOM"},
    {GHOST_NDOF_BUTTON_DOMINANT, "NDOF_BUTTON_DOMINANT"},
    {GHOST_NDOF_BUTTON_PLUS, "NDOF_BUTTON_PLUS"},
    {GHOST_NDOF_BUTTON_MINUS, "NDOF_BUTTON_MINUS"},
    {GHOST_NDOF_BUTTON_V1, "NDOF_BUTTON_VIEW_1"},
    {GHOST_NDOF_BUTTON_V2, "NDOF_BUTTON_VIEW_2"},
    {GHOST_NDOF_BUTTON_V3, "NDOF_BUTTON_VIEW_3"},
    {GHOST_NDOF_BUTTON_SAVE_V1, "NDOF_BUTTON_SAVE_VIEW_1"},
    {GHOST_NDOF_BUTTON_SAVE_V2, "NDOF_BUTTON_SAVE_VIEW_2"},
    {GHOST_NDOF_BUTTON_SAVE_V3, "NDOF_BUTTON_SAVE_VIEW_3"},
    {GHOST_NDOF_BUTTON_KBP_F1, "NDOF_BUTTON_KBP_F1"},
    {GHOST_NDOF_BUTTON_KBP_F2, "NDOF_BUTTON_KBP_F2"},
    {GHOST_NDOF_BUTTON_KBP_F3, "NDOF_BUTTON_KBP_F3"},
    {GHOST_NDOF_BUTTON_KBP_F4, "NDOF_BUTTON_KBP_F4"},
    {GHOST_NDOF_BUTTON_KBP_F5, "NDOF_BUTTON_KBP_F5"},
    {GHOST_NDOF_BUTTON_KBP_F6, "NDOF_BUTTON_KBP_F6"},
    {GHOST_NDOF_BUTTON_KBP_F7, "NDOF_BUTTON_KBP_F7"},
    {GHOST_NDOF_BUTTON_KBP_F8, "NDOF_BUTTON_KBP_F8"},
    {GHOST_NDOF_BUTTON_KBP_F9, "NDOF_BUTTON_KBP_F9"},
    {GHOST_NDOF_BUTTON_KBP_F10, "NDOF_BUTTON_KBP_F10"},
    {GHOST_NDOF_BUTTON_KBP_F11, "NDOF_BUTTON_KBP_F11"},
    {GHOST_NDOF_BUTTON_KBP_F12, "NDOF_BUTTON_KBP_F12"},
    {GHOST_NDOF_BUTTON_NP_F1, "NDOF_BUTTON_NP_F1"},
    {GHOST_NDOF_BUTTON_NP_F2, "NDOF_BUTTON_NP_F2"},
    {GHOST_NDOF_BUTTON_NP_F3, "NDOF_BUTTON_NP_F3"},
    {GHOST_NDOF_BUTTON_NP_F4, "NDOF_BUTTON_NP_F4"},
};
...
static const GHOST_NDOF_ButtonT ndof_HID_map_Shared3Dx[] = {
    GHOST_NDOF_BUTTON_MENU,     GHOST_NDOF_BUTTON_FIT,      GHOST_NDOF_BUTTON_TOP,    GHOST_NDOF_BUTTON_LEFT,
    GHOST_NDOF_BUTTON_RIGHT,    GHOST_NDOF_BUTTON_FRONT,    GHOST_NDOF_BUTTON_BOTTOM, GHOST_NDOF_BUTTON_BACK,
    GHOST_NDOF_BUTTON_ROLL_CW,  GHOST_NDOF_BUTTON_ROLL_CCW, GHOST_NDOF_BUTTON_ISO1,   GHOST_NDOF_BUTTON_ISO2,
    GHOST_NDOF_BUTTON_1,        GHOST_NDOF_BUTTON_2,        GHOST_NDOF_BUTTON_3,      GHOST_NDOF_BUTTON_4,
    GHOST_NDOF_BUTTON_5,        GHOST_NDOF_BUTTON_6,        GHOST_NDOF_BUTTON_7,      GHOST_NDOF_BUTTON_8,
    GHOST_NDOF_BUTTON_9,        GHOST_NDOF_BUTTON_10,       GHOST_NDOF_BUTTON_ESC,    GHOST_NDOF_BUTTON_ALT,
    GHOST_NDOF_BUTTON_SHIFT,    GHOST_NDOF_BUTTON_CTRL,     GHOST_NDOF_BUTTON_ROTATE, GHOST_NDOF_BUTTON_PANZOOM,
    GHOST_NDOF_BUTTON_DOMINANT, GHOST_NDOF_BUTTON_PLUS,     GHOST_NDOF_BUTTON_MINUS};
...
static const GHOST_NDOF_ButtonT ndof_HID_map_SpacePilot[] = {
    GHOST_NDOF_BUTTON_1,      GHOST_NDOF_BUTTON_2,     GHOST_NDOF_BUTTON_3,        GHOST_NDOF_BUTTON_4,
    GHOST_NDOF_BUTTON_5,      GHOST_NDOF_BUTTON_6,     GHOST_NDOF_BUTTON_TOP,      GHOST_NDOF_BUTTON_LEFT,
    GHOST_NDOF_BUTTON_RIGHT,  GHOST_NDOF_BUTTON_FRONT, GHOST_NDOF_BUTTON_ESC,      GHOST_NDOF_BUTTON_ALT,
    GHOST_NDOF_BUTTON_SHIFT,  GHOST_NDOF_BUTTON_CTRL,  GHOST_NDOF_BUTTON_FIT,      GHOST_NDOF_BUTTON_MENU,
    GHOST_NDOF_BUTTON_PLUS,   GHOST_NDOF_BUTTON_MINUS, GHOST_NDOF_BUTTON_DOMINANT, GHOST_NDOF_BUTTON_ROTATE,
...
void GHOST_NDOFManager::updateButton(int button_number, bool press, uint64_t time)
{
  ...
  // For older devices check the button map
