...
template Eigen::Matrix<int, -1, 1, 0, -1, 1> igl::colon<int, int, long long int>(int,
                                                                                 long long int);
template Eigen::Matrix<double, -1, 1, 0, -1, 1> igl::colon<double, double, double>(double, double);
// generated by autoexplicit.sh
template void igl::colon<int, long, int, int>(int,
                                              long,
                                              int,
                                              Eigen::Matrix<int, -1, 1, 0, -1, 1> &);
template void igl::colon<int, int, long, int>(int,
                                              int,
                                              long,
                                              Eigen::Matrix<int, -1, 1, 0, -1, 1> &);
...
template void igl::colon<int, long long int, int>(int,
                                                  long long int,
                                                  Eigen::Matrix<int, -1, 1, 0, -1, 1> &);
...
template void igl::colon<int, double, double, double>(int,
                                                      double,
                                                      double,
                                                      Eigen::Matrix<double, -1, 1, 0, -1, 1> &);
template void igl::colon<double, double, double>(double,
                                                 double,
                                                 Eigen::Matrix<double, -1, 1, 0, -1, 1> &);
#  ifdef WIN32
template void igl::colon<int, long long, long>(int,
                                               long long,
