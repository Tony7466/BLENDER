...
template void igl::find<double,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
...
template void igl::find<double,
    ...
    Eigen::MatrixBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, -1, 0, -1, -1>> &);
template void igl::find<Eigen::Matrix<int, -1, 1, 0, -1, 1>, Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
...
template void igl::find<double,
                        ...
                        Eigen::Matrix<double, -1, 1, 0, -1, 1>>(
    Eigen::SparseMatrix<double, 0, int> const &,
    Eigen::MatrixBase<Eigen::Matrix<long, -1, 1, 0, -1, 1>> &,
    Eigen::MatrixBase<Eigen::Matrix<long, -1, 1, 0, -1, 1>> &,
    Eigen::MatrixBase<Eigen::Matrix<double, -1, 1, 0, -1, 1>> &);
#endif
