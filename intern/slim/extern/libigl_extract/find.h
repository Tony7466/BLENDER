...
inline void find(const Eigen::SparseMatrix<T> &X,
...
inline void find(const Eigen::PlainObjectBase<DerivedX> &X,
                 Eigen::PlainObjectBase<DerivedI> &I,
                 Eigen::PlainObjectBase<DerivedJ> &J,
                 Eigen::PlainObjectBase<DerivedV> &V);
template<typename DerivedX, typename DerivedI>
inline void find(const Eigen::PlainObjectBase<DerivedX> &X, Eigen::PlainObjectBase<DerivedI> &I);
...
//   V  nnz vector of type T non-zeros entries in X
template<typename T>
inline void find(const Eigen::SparseVector<T> &X,
