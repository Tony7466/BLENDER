                          ...
                          std::vector<size_t> &index_map)
{
  ...
  // Sort the index map, using unsorted for comparison
  std::sort(
      index_map.begin(), index_map.end(), igl::IndexLessThan<const std::vector<T> &>(unsorted));
...
template void igl::sort<Eigen::Matrix<double, 1, 3, 1, 1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
// generated by autoexplicit.sh
template void igl::sort<int>(std::vector<int, std::allocator<int>> const &,
                             bool,
                             std::vector<int, std::allocator<int>> &,
                             std::vector<size_t, class std::allocator<size_t>> &);
...
template void igl::sort<Eigen::Matrix<int, -1, 2, 0, -1, 2>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
template void igl::sort<Eigen::Matrix<int, -1, 1, 0, -1, 1>, Eigen::Matrix<int, -1, 1, 0, -1, 1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> const &,
    int,
    bool,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 1, 0, -1, 1>> &,
...
template void igl::sort_new<Eigen::Matrix<int, 1, 6, 1, 1, 6>,
                            ...
                            Eigen::Matrix<int, 1, 6, 1, 1, 6>>(
    Eigen::PlainObjectBase<Eigen::Matrix<int, 1, 6, 1, 1, 6>> const &,
    int,
    bool,
    Eigen::PlainObjectBase<Eigen::Matrix<int, 1, 6, 1, 1, 6>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, 1, 6, 1, 1, 6>> &);
template void igl::sort<Eigen::Matrix<int, -1, 2, 0, -1, 2>, Eigen::Matrix<int, -1, 2, 0, -1, 2>>(
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, 2, 0, -1, 2>> const &,
    int,
    bool,
...
template void igl::sort<Eigen::Matrix<int, -1, 3, 0, -1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
template void igl::sort<long>(std::vector<long, std::allocator<long>> const &,
                              bool,
...
template void igl::sort<Eigen::Matrix<double, 1, 3, 1, 1, 3>,
    ...
    Eigen::PlainObjectBase<Eigen::Matrix<double, 1, 3, 1, 1, 3>> &,
    Eigen::PlainObjectBase<Eigen::Matrix<int, -1, -1, 0, -1, -1>> &);
template void igl::sort<Eigen::Matrix<float, -1, 3, 0, -1, 3>,
                        Eigen::Matrix<float, -1, 3, 0, -1, 3>,
                        Eigen::Matrix<int, -1, -1, 0, -1, -1>>(
    Eigen::PlainObjectBase<Eigen::Matrix<float, -1, 3, 0, -1, 3>> const &,
    int,
    bool,
