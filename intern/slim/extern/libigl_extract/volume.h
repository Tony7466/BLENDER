...
IGL_INLINE void volume(const Eigen::PlainObjectBase<DerivedV> &V,
...
template<typename DerivedA,
         ...
         typename DerivedD,
         typename Derivedvol>
IGL_INLINE void volume(const Eigen::PlainObjectBase<DerivedA> &A,
...
IGL_INLINE typename VecA::Scalar volume_single(const VecA &a,
                                               const VecB &b,
                                               const VecC &c,
                                               const VecD &d);
// Intrinsic version:
...
IGL_INLINE void volume(const Eigen::PlainObjectBase<DerivedL> &L,
                       Eigen::PlainObjectBase<Derivedvol> &vol);
}  // namespace igl
