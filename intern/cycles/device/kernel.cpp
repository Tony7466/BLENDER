...
bool device_kernel_has_shading(DeviceKernel kernel)
{
  return (kernel == DEVICE_KERNEL_INTEGRATOR_SHADE_BACKGROUND ||
          ...
          kernel == DEVICE_KERNEL_INTEGRATOR_SHADE_BLOCKED_LIGHT ||
...
bool device_kernel_has_intersection(DeviceKernel kernel)
{
  return (kernel == DEVICE_KERNEL_INTEGRATOR_INTERSECT_CLOSEST ||
          ...
          kernel == DEVICE_KERNEL_INTEGRATOR_INTERSECT_BLOCKED_LIGHT ||
          kernel == DEVICE_KERNEL_INTEGRATOR_SHADE_SURFACE_RAYTRACE ||
          kernel == DEVICE_KERNEL_INTEGRATOR_SHADE_SURFACE_MNEE);
}
...
const char *device_kernel_as_string(DeviceKernel kernel)
{
  switch (kernel) {
    ...
    case DEVICE_KERNEL_INTEGRATOR_INTERSECT_BLOCKED_LIGHT:
      return "integrator_intersect_blocked_light";
    ...
    case DEVICE_KERNEL_INTEGRATOR_SHADE_BLOCKED_LIGHT:
      return "integrator_shade_blocked_light";
