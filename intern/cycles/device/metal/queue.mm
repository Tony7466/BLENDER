                               ...
                               DeviceKernelArguments const &args)
{
  ...
  [metal_device_->mtlAncillaryArgEncoder setBuffer:metal_device_->texture_bindings_3d
                                            offset:0
                                           atIndex:1];
  [metal_device_->mtlAncillaryArgEncoder setBuffer:metal_device_->texture_buffers
                                            offset:0
                                           atIndex:2];
  if (@available(macos 12.0, *)) {
...
void MetalDeviceQueue::prepare_resources(DeviceKernel kernel)
{
  ...
  [mtlComputeEncoder_ useResource:metal_device_->texture_buffers usage:MTLResourceUsageRead];
}
