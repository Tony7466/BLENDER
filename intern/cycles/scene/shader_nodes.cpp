...
NODE_DEFINE(LinearSystemSolverNode)
{
  NodeType *type = NodeType::add("linear_system_solver", create, NodeType::SHADER);

  static NodeEnum matrix_dimension_enum;
  matrix_dimension_enum.insert("1x1", 1);
  matrix_dimension_enum.insert("2x2", 2);
  matrix_dimension_enum.insert("3x3", 3);
  matrix_dimension_enum.insert("4x4", 4);
  SOCKET_ENUM(matrix_dimension, "Matrix Dimension", matrix_dimension_enum, 3);

  SOCKET_IN_POINT(b_vector, "b Vector", make_float3(0.0f, 0.0f, 0.0f));
  SOCKET_IN_FLOAT(b_vector_w, "b Vector W", 0.0f);
  SOCKET_IN_POINT(column_1, "Column 1", make_float3(1.0f, 0.0f, 0.0f));
  SOCKET_IN_FLOAT(column_1_w, "Column 1 W", 0.0f);
  SOCKET_IN_POINT(column_2, "Column 2", make_float3(0.0f, 1.0f, 0.0f));
  SOCKET_IN_FLOAT(column_2_w, "Column 2 W", 0.0f);
  SOCKET_IN_POINT(column_3, "Column 3", make_float3(0.0f, 0.0f, 1.0f));
  SOCKET_IN_FLOAT(column_3_w, "Column 3 W", 0.0f);
  SOCKET_IN_POINT(column_4, "Column 4", make_float3(0.0f, 0.0f, 0.0f));
  SOCKET_IN_FLOAT(column_4_w, "Column 4 W", 1.0f);

  SOCKET_OUT_POINT(solution, "Solution");
  SOCKET_OUT_FLOAT(solution_w, "Solution W");

  return type;
}

LinearSystemSolverNode::LinearSystemSolverNode() : ShaderNode(get_node_type()) {}

void LinearSystemSolverNode::compile(SVMCompiler &compiler)
{
  int b_vector_stack_offset = compiler.stack_assign_if_linked(input("b Vector"));
  int b_vector_w_stack_offset = compiler.stack_assign_if_linked(input("b Vector W"));
  int column_1_stack_offset = compiler.stack_assign_if_linked(input("Column 1"));
  int column_1_w_stack_offset = compiler.stack_assign_if_linked(input("Column 1 W"));
  int column_2_stack_offset = compiler.stack_assign_if_linked(input("Column 2"));
  int column_2_w_stack_offset = compiler.stack_assign_if_linked(input("Column 2 W"));
  int column_3_stack_offset = compiler.stack_assign_if_linked(input("Column 3"));
  int column_3_w_stack_offset = compiler.stack_assign_if_linked(input("Column 3 W"));
  int column_4_stack_offset = compiler.stack_assign_if_linked(input("Column 4"));
  int column_4_w_stack_offset = compiler.stack_assign_if_linked(input("Column 4 W"));

  int solution_stack_offset = compiler.stack_assign_if_linked(output("Solution"));
  int solution_w_stack_offset = compiler.stack_assign_if_linked(output("Solution W"));

  compiler.add_node(NODE_LINEAR_SYSTEM_SOLVER,
                    compiler.encode_uchar4(b_vector_stack_offset,
                                           b_vector_w_stack_offset,
                                           column_1_stack_offset,
                                           column_1_w_stack_offset),
                    compiler.encode_uchar4(column_2_stack_offset,
                                           column_2_w_stack_offset,
                                           column_3_stack_offset,
                                           column_3_w_stack_offset),
                    compiler.encode_uchar4(column_4_stack_offset,
                                           column_4_w_stack_offset,
                                           solution_stack_offset,
                                           solution_w_stack_offset));

  compiler.add_node(__float_as_int(b_vector.x),
                    __float_as_int(b_vector.y),
                    __float_as_int(b_vector.z),
                    __float_as_int(b_vector_w));
  compiler.add_node(__float_as_int(column_1.x),
                    __float_as_int(column_1.y),
                    __float_as_int(column_1.z),
                    __float_as_int(column_1_w));
  compiler.add_node(__float_as_int(column_2.x),
                    __float_as_int(column_2.y),
                    __float_as_int(column_2.z),
                    __float_as_int(column_2_w));
  compiler.add_node(__float_as_int(column_3.x),
                    __float_as_int(column_3.y),
                    __float_as_int(column_3.z),
                    __float_as_int(column_3_w));
  compiler.add_node(__float_as_int(column_4.x),
                    __float_as_int(column_4.y),
                    __float_as_int(column_4.z),
                    __float_as_int(column_4_w));
  compiler.add_node(matrix_dimension);
}

void LinearSystemSolverNode::compile(OSLCompiler &compiler)
{
  compiler.parameter(this, "matrix_dimension");
  compiler.add(this, "node_linear_system_solver");
}
