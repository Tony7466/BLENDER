                                               ...
                                               Progress &progress)
{
  ...
  dscene->attributes_uint.alloc(attr_uint_size);
  ...
  dscene->attributes_uint.copy_to_device_if_modified();
