...
void RenderStats::collect_profiling(Scene *scene, Profiler &prof)
{
  ...
  kernel.add_entry("Intersect Blocked Light", prof.get_event(PROFILING_INTERSECT_BLOCKED_LIGHT));
  ...
  shadow.add_entry("Blocked Light", prof.get_event(PROFILING_SHADE_BLOCKED_LIGHT));
