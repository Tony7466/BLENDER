                                         ...
                                         Progress & /*progress*/)
{
  ...
  ktables->ggx_gen_schlick_ior_f0 = ensure_bsdf_table(dscene, scene, table_ggx_gen_schlick_ior_f0);
  ktables->ggx_gen_schlick_ior_f90 = ensure_bsdf_table(
      dscene, scene, table_ggx_gen_schlick_ior_f90);
