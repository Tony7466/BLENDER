...
enum ProfilingEvent : uint32_t {
  ...
  PROFILING_RESTIR_RESERVOIR_PASSES,
  PROFILING_RESTIR_LIGHT_RESAMPLING,
  PROFILING_RESTIR_BSDF_RESAMPLING,
  PROFILING_RESTIR_INITIAL_RESAMPLING,
  PROFILING_RESTIR_SPATIAL_RESAMPLING,
  PROFILING_RESTIR_LIGHT_SETUP,
  PROFILING_RESTIR_SURFACE_DATA_SETUP,
  PROFILING_RESTIR_SHADER_SETUP,
  PROFILING_RESTIR_BSDF_EVAL,
  PROFILING_RESTIR_LIGHT_EVAL,
  PROFILING_RESTIR_RESERVOIR,
