...
void BlenderSync::sync_integrator(BL::ViewLayer &b_view_layer, bool background)
{
  ...
  if (denoise_params.use) {
    ...
    integrator->set_denoise_allow_oidn_gpu(denoise_params.allow_oidn_gpu);
                                              ...
                                              bool background)
{
  ...
  if (background) {
    ...
    denoising.allow_oidn_gpu = get_boolean(cscene, "denoising_oidn_allow_gpu");
    ...
    denoising.allow_oidn_gpu = get_boolean(cscene, "preview_denoising_oidn_allow_gpu");
    denoising.prefilter = (DenoiserPrefilter)get_enum(
