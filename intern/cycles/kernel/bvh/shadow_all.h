            ...
            if (hit) {
              ...
              if (record_intersection) {
                ...
                if (*r_num_recorded_hits < max_record_hits || isect.t < tmax_hits) {
                   ...
                   * largest distance. We want to find the N closest intersections. */
                  const uint isect_index = min(*r_num_recorded_hits, max_recorded_hit);
                  ...
                  if (*r_num_recorded_hits + 1 >= max_record_hits) {
                    /* Find the largest distance after insertion. */
                    max_recorded_hit = 0;
