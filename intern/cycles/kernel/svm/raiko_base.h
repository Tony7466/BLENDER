...
ccl_device float3
calculate_out_fields_2d_full_roundness_irregular_elliptical(
...
ccl_device float3
calculate_out_fields_2d_irregular_elliptical(
                                             bool calculate_r_gon_parameter_field,
                                             ...
                                             float l_projection_2d)
{
      ...
      (x_axis_A_coord < M_TAU_F - last_ref_A_x_axis - ref_A_bevel_start))
  {
    if ((ref_A_coord >= ref_A_bevel_start) && (ref_A_coord < ref_A_next_ref - ref_A_bevel_start)) {
      ...
      return make_float3(
          l_angle_bisector_2d, r_gon_parameter_2d, max_unit_parameter_2d);
    }
    else {
...
ccl_device float3
calculate_out_fields_2d_full_roundness_irregular_circular(
                                                          bool calculate_r_gon_parameter_field,
                                                          bool calculate_max_unit_parameter,
                                                          bool normalize_r_gon_parameter,
                                                          float r_gon_sides,
...
ccl_device float3
calculate_out_fields_2d_irregular_circular(
                                           bool calculate_r_gon_parameter_field,
                                           bool calculate_max_unit_parameter,
                                           bool normalize_r_gon_parameter,
                                           float r_gon_sides,
...
ccl_device float3 calculate_out_fields_2d(
                                          bool calculate_r_gon_parameter_field,
                                          bool calculate_max_unit_parameter,
                                          bool normalize_r_gon_parameter,
...
ccl_device float3 calculate_out_fields_4d(
                                          bool calculate_r_gon_parameter_field,
                                          bool calculate_max_unit_parameter,
                                          bool normalize_r_gon_parameter,
                                          bool elliptical_corners,
...
uint normalize_r_gon_parameter, elliptical_corners;
  ...
  svm_unpack_node_uchar4(node.z,
                         &(so.scale),
                         &(so.r_gon_sides), &(so.r_gon_roundness), &(so.r_gon_exponent));
  ...
  float3 out_variables = calculate_out_fields_4d(
      ...
      scale * make_float4(in_vector.x, in_vector.y, in_vector.z, in_w));
