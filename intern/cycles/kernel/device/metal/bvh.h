                                            ...
                                            int type)
{
  ...
  /* We can ignore motion blur here because we don't need the positions, and it doesn't affect the radius. */
  float radius[4];
                                          ...
                                          ccl_private Intersection *isect)
{
  ...
  metalrt_intersect.assume_geometry_type(metal::raytracing::geometry_type::triangle
    | (kernel_data.bvh.have_curves ? metal::raytracing::geometry_type::curve : metal::raytracing::geometry_type::none)
    | (kernel_data.bvh.have_points ? metal::raytracing::geometry_type::bounding_box : metal::raytracing::geometry_type::none));
