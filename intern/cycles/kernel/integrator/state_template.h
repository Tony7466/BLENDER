...
KERNEL_STRUCT_MEMBER(ray, packed_ray, packed, KERNEL_FEATURE_PATH_TRACING)
...
KERNEL_STRUCT_MEMBER(isect, Intersection, packed, KERNEL_FEATURE_PATH_TRACING)
...
KERNEL_STRUCT_MEMBER(subsurface, packed_subsurface, packed, KERNEL_FEATURE_SUBSURFACE)
