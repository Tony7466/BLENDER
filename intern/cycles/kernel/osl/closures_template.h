...
OSL_CLOSURE_STRUCT_BEGIN(PortalBSDF, portal_bsdf)
  OSL_CLOSURE_STRUCT_MEMBER(PortalBSDF, VECTOR, packed_float3, position, NULL)
  OSL_CLOSURE_STRUCT_MEMBER(PortalBSDF, VECTOR, packed_float3, direction, NULL)
OSL_CLOSURE_STRUCT_END(PortalBSDF, portal_bsdf)
