                                          ...
                                          float3 *layer_albedo)
{
  ...
  bsdf->N = safe_normal(sd, closure->N);
                                             ...
                                             float3 *layer_albedo)
{
  ...
  bsdf->N = maybe_ensure_valid_specular_reflection(sd, safe_normal(sd, closure->N));
                                         ...
                                         float3 *layer_albedo)
{
  ...
  bssrdf->N = maybe_ensure_valid_specular_reflection(sd, safe_normal(sd, closure->N));
