...
ExternalProject_Add(external_x265_12
  ...
  CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${LIBDIR}/x265_12 ${DEFAULT_CMAKE_FLAGS} ${X265_12_EXTRA_ARGS}
...
ExternalProject_Add(external_x265_10
  ...
  CMAKE_GENERATOR ${PLATFORM_ALT_GENERATOR}
  SOURCE_SUBDIR source
  CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${LIBDIR}/x265_10 ${DEFAULT_CMAKE_FLAGS} ${X265_10_EXTRA_ARGS}
...
ExternalProject_Add(external_x265
  ...
  SOURCE_SUBDIR source
  LIST_SEPARATOR ^^
  CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${LIBDIR}/x265 ${DEFAULT_CMAKE_FLAGS} ${X265_EXTRA_ARGS}
