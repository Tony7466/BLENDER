...
if(MSVC_CLANG) # Clangs version of cl doesn't support all flags
  ...
  if(CMAKE_SYSTEM_PROCESSOR STREQUAL "ARM64")
    string(APPEND CMAKE_CXX_FLAGS " /clang:-funsigned-char /clang:-fno-strict-aliasing /clang:-ffp-contract=off")
    string(APPEND CMAKE_C_FLAGS " /clang:-funsigned-char /clang:-fno-strict-aliasing /clang:-ffp-contract=off")
  endif()
else()
